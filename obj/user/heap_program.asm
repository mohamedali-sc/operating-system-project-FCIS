...
void _main(void)
{
  ...
  800082:	e8 5a 1b 00 00       	call   801be1 <sys_pf_calculate_allocated_pages>
  ...
  8000d1:	e8 6c 17 00 00       	call   801842 <free>
  8000d6:	83 c4 10             	add    $0x10,%esp
		free(y);
  8000d9:	83 ec 0c             	sub    $0xc,%esp
  8000dc:	ff 75 c8             	pushl  -0x38(%ebp)
  8000df:	e8 5e 17 00 00       	call   801842 <free>
  ...
  8000e7:	e8 72 1a 00 00       	call   801b5e <sys_calculate_free_frames>
  ...
  8001e8:	e8 71 19 00 00       	call   801b5e <sys_calculate_free_frames>
...
libmain(int argc, char **argv)
{
  ...
  800229:	e8 65 18 00 00       	call   801a93 <sys_getenvindex>
  ...
  8002a6:	e8 83 19 00 00       	call   801c2e <sys_disable_interrupt>
	cprintf("**************************************\n");
  ...
  800337:	e8 0c 19 00 00       	call   801c48 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  80034f:	e8 0b 17 00 00       	call   801a5f <sys_env_destroy>
...
exit(void)
{
  ...
  80035d:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800360:	e8 60 17 00 00       	call   801ac5 <sys_env_exit>
}
  800365:	90                   	nop
  800366:	c9                   	leave  
  800367:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  80057a:	51                   	push   %ecx
  80057b:	52                   	push   %edx
  80057c:	e8 9c 14 00 00       	call   801a1d <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8005f2:	50                   	push   %eax
  8005f3:	e8 25 14 00 00       	call   801a1d <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  80063a:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80063d:	e8 ec 15 00 00       	call   801c2e <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  80065a:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  80065d:	e8 e6 15 00 00       	call   801c48 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8006a7:	e8 a4 19 00 00       	call   802050 <__udivdi3>
  ...
  8006f5:	52                   	push   %edx
  8006f6:	50                   	push   %eax
  8006f7:	e8 64 1a 00 00       	call   802160 <__umoddi3>
...
//	while(size%PAGE_SIZE!=0){
  ...
  80145a:	77 21                	ja     80147d <malloc+0xe9>
  ...
  80146b:	76 10                	jbe    80147d <malloc+0xe9>
					ni=PAGE_SIZE;
  80146d:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%ebp)
					flag1=1;
  801474:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
					break;
  80147b:	eb 0d                	jmp    80148a <malloc+0xf6>
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		...
		for(int j=i;j<i+size;j+=PAGE_SIZE){
			for(int k=0;k<count;k++){
  80147d:	ff 45 d8             	incl   -0x28(%ebp)
  801480:	a1 28 30 80 00       	mov    0x803028,%eax
  801485:	39 45 d8             	cmp    %eax,-0x28(%ebp)
  801488:	7c c1                	jl     80144b <malloc+0xb7>
					ni=PAGE_SIZE;
					flag1=1;
					break;
				}
  ...
  80148e:	74 09                	je     801499 <malloc+0x105>
				flag0=0;
  801490:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
				break;
  801497:	eb 16                	jmp    8014af <malloc+0x11b>
		cprintf("arr %d end is: %x\n",i,arr_add[i].end);
	}
  ...
  8014ad:	77 93                	ja     801442 <malloc+0xae>
		...
		if(flag0){
  8014af:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  8014b3:	0f 84 a2 00 00 00    	je     80155b <malloc+0x1c7>

			int f=1;
  8014b9:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)

			arr[count2].start=i;
  8014c0:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8014c3:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  8014c6:	89 c8                	mov    %ecx,%eax
  8014c8:	01 c0                	add    %eax,%eax
  8014ca:	01 c8                	add    %ecx,%eax
  8014cc:	c1 e0 02             	shl    $0x2,%eax
  8014cf:	05 20 31 80 00       	add    $0x803120,%eax
  8014d4:	89 10                	mov    %edx,(%eax)
			arr[count2].end = i+size;
  8014d6:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8014d9:	8b 45 08             	mov    0x8(%ebp),%eax
  8014dc:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
  8014df:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8014e2:	89 d0                	mov    %edx,%eax
  8014e4:	01 c0                	add    %eax,%eax
  8014e6:	01 d0                	add    %edx,%eax
  8014e8:	c1 e0 02             	shl    $0x2,%eax
  8014eb:	05 24 31 80 00       	add    $0x803124,%eax
  8014f0:	89 08                	mov    %ecx,(%eax)
			arr[count2].space=0;
  8014f2:	8b 55 f4             	mov    -0xc(%ebp),%edx
  8014f5:	89 d0                	mov    %edx,%eax
  8014f7:	01 c0                	add    %eax,%eax
  8014f9:	01 d0                	add    %edx,%eax
  8014fb:	c1 e0 02             	shl    $0x2,%eax
  8014fe:	05 28 31 80 00       	add    $0x803128,%eax
  801503:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			count2++;
  801509:	ff 45 f4             	incl   -0xc(%ebp)

			for(int l=0;l<count;l++){
  80150c:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
  801513:	eb 36                	jmp    80154b <malloc+0x1b7>
				if(i+size<arr_add[l].start){
  801515:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801518:	8b 45 08             	mov    0x8(%ebp),%eax
  80151b:	01 c2                	add    %eax,%edx
  80151d:	8b 45 d0             	mov    -0x30(%ebp),%eax
  801520:	8b 04 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%eax
  801527:	39 c2                	cmp    %eax,%edx
  801529:	73 1d                	jae    801548 <malloc+0x1b4>
					ni=arr_add[l].end-i;
  80152b:	8b 45 d0             	mov    -0x30(%ebp),%eax
  80152e:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  801535:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801538:	29 c2                	sub    %eax,%edx
  80153a:	89 d0                	mov    %edx,%eax
  80153c:	89 45 ec             	mov    %eax,-0x14(%ebp)
					f=0;
  80153f:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					break;
  801546:	eb 0d                	jmp    801555 <malloc+0x1c1>
			arr[count2].start=i;
			arr[count2].end = i+size;
			arr[count2].space=0;
			count2++;
			...
			for(int l=0;l<count;l++){
  801548:	ff 45 d0             	incl   -0x30(%ebp)
  80154b:	a1 28 30 80 00       	mov    0x803028,%eax
  801550:	39 45 d0             	cmp    %eax,-0x30(%ebp)
  801553:	7c c0                	jl     801515 <malloc+0x181>
					break;
  ...
  801559:	75 1d                	jne    801578 <malloc+0x1e4>
				break;
			}
		...
		flag1=0;
  80155b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  ...
  801565:	01 45 e4             	add    %eax,-0x1c(%ebp)
  801568:	a1 04 30 80 00       	mov    0x803004,%eax
  80156d:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801570:	0f 8c bd fe ff ff    	jl     801433 <malloc+0x9f>
  801576:	eb 01                	jmp    801579 <malloc+0x1e5>
  ...
  80157d:	75 7a                	jne    8015f9 <malloc+0x265>
		//cprintf("hellllllllOOlooo");
		if((int)(base_add+size-1)>=(int)USER_HEAP_MAX)
  80157f:	8b 15 04 30 80 00    	mov    0x803004,%edx
  801585:	8b 45 08             	mov    0x8(%ebp),%eax
  801588:	01 d0                	add    %edx,%eax
  80158a:	48                   	dec    %eax
  80158b:	3d 00 00 00 a0       	cmp    $0xa0000000,%eax
  801590:	7c 0a                	jl     80159c <malloc+0x208>
			return NULL;
  801592:	b8 00 00 00 00       	mov    $0x0,%eax
  801597:	e9 a4 02 00 00       	jmp    801840 <malloc+0x4ac>
		else{
			uint32 s=base_add;
  80159c:	a1 04 30 80 00       	mov    0x803004,%eax
  8015a1:	89 45 a4             	mov    %eax,-0x5c(%ebp)
			//cprintf("s: %x",s);
			arr_add[count].start=s;
  8015a4:	a1 28 30 80 00       	mov    0x803028,%eax
  8015a9:	8b 55 a4             	mov    -0x5c(%ebp),%edx
  8015ac:	89 14 c5 e0 05 82 00 	mov    %edx,0x8205e0(,%eax,8)
		    sys_allocateMem(s,size);
  8015b3:	83 ec 08             	sub    $0x8,%esp
  8015b6:	ff 75 08             	pushl  0x8(%ebp)
  8015b9:	ff 75 a4             	pushl  -0x5c(%ebp)
  8015bc:	e8 04 06 00 00       	call   801bc5 <sys_allocateMem>
  8015c1:	83 c4 10             	add    $0x10,%esp
			base_add+=size;
  8015c4:	8b 15 04 30 80 00    	mov    0x803004,%edx
  8015ca:	8b 45 08             	mov    0x8(%ebp),%eax
  8015cd:	01 d0                	add    %edx,%eax
  8015cf:	a3 04 30 80 00       	mov    %eax,0x803004
			arr_add[count].end=base_add;
  8015d4:	a1 28 30 80 00       	mov    0x803028,%eax
  8015d9:	8b 15 04 30 80 00    	mov    0x803004,%edx
  8015df:	89 14 c5 e4 05 82 00 	mov    %edx,0x8205e4(,%eax,8)
			count++;
  8015e6:	a1 28 30 80 00       	mov    0x803028,%eax
  8015eb:	40                   	inc    %eax
  8015ec:	a3 28 30 80 00       	mov    %eax,0x803028

			return (void*)s;
  8015f1:	8b 45 a4             	mov    -0x5c(%ebp),%eax
  8015f4:	e9 47 02 00 00       	jmp    801840 <malloc+0x4ac>
	}
	else{
  ...
  8015f9:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%ebp)
  801600:	e9 ac 00 00 00       	jmp    8016b1 <malloc+0x31d>
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801605:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801608:	89 d0                	mov    %edx,%eax
  80160a:	01 c0                	add    %eax,%eax
  80160c:	01 d0                	add    %edx,%eax
  80160e:	c1 e0 02             	shl    $0x2,%eax
  801611:	05 24 31 80 00       	add    $0x803124,%eax
  801616:	8b 00                	mov    (%eax),%eax
  801618:	89 45 c8             	mov    %eax,-0x38(%ebp)
  80161b:	eb 7e                	jmp    80169b <malloc+0x307>
			int flag=0;
  80161d:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
			for(int k=0;k<count;k++){
  801624:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
  80162b:	eb 57                	jmp    801684 <malloc+0x2f0>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
  80162d:	8b 45 c0             	mov    -0x40(%ebp),%eax
  801630:	8b 14 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%edx
  801637:	8b 45 c8             	mov    -0x38(%ebp),%eax
  80163a:	39 c2                	cmp    %eax,%edx
  80163c:	77 1a                	ja     801658 <malloc+0x2c4>
  80163e:	8b 45 c0             	mov    -0x40(%ebp),%eax
  801641:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  801648:	8b 45 c8             	mov    -0x38(%ebp),%eax
  80164b:	39 c2                	cmp    %eax,%edx
  80164d:	76 09                	jbe    801658 <malloc+0x2c4>
								flag=1;
  80164f:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
								break;}
  801656:	eb 36                	jmp    80168e <malloc+0x2fa>
			arr[i].space++;
  801658:	8b 55 cc             	mov    -0x34(%ebp),%edx
  ...
  80166b:	8d 48 01             	lea    0x1(%eax),%ecx
  80166e:	8b 55 cc             	mov    -0x34(%ebp),%edx
  ...
  80167f:	89 08                	mov    %ecx,(%eax)
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
			int flag=0;
			for(int k=0;k<count;k++){
  801681:	ff 45 c0             	incl   -0x40(%ebp)
  801684:	a1 28 30 80 00       	mov    0x803028,%eax
  801689:	39 45 c0             	cmp    %eax,-0x40(%ebp)
  80168c:	7c 9f                	jl     80162d <malloc+0x299>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
								flag=1;
								break;}
			arr[i].space++;
			...
			if(flag)
  80168e:	83 7d c4 00          	cmpl   $0x0,-0x3c(%ebp)
  801692:	75 19                	jne    8016ad <malloc+0x319>
	else{
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801694:	81 45 c8 00 10 00 00 	addl   $0x1000,-0x38(%ebp)
  80169b:	8b 55 c8             	mov    -0x38(%ebp),%edx
  80169e:	a1 04 30 80 00       	mov    0x803004,%eax
  8016a3:	39 c2                	cmp    %eax,%edx
  8016a5:	0f 82 72 ff ff ff    	jb     80161d <malloc+0x289>
  8016ab:	eb 01                	jmp    8016ae <malloc+0x31a>
								flag=1;
								break;}
			arr[i].space++;
			}
  ...
  8016ad:	90                   	nop
	...
	for(int i=0;i<count2;i++){
  8016ae:	ff 45 cc             	incl   -0x34(%ebp)
  8016b1:	8b 45 cc             	mov    -0x34(%ebp),%eax
  8016b4:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  8016b7:	0f 8c 48 ff ff ff    	jl     801605 <malloc+0x271>
			if(flag)
				break;
		}
	}
	...
	int index=0;
  8016bd:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
	int min=9999999;
  8016c4:	c7 45 b8 7f 96 98 00 	movl   $0x98967f,-0x48(%ebp)
	for(int i=0;i<count2;i++){
  8016cb:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
  8016d2:	eb 37                	jmp    80170b <malloc+0x377>
		//cprintf("arr %d size is: %x\n",i,arr[i].space);
		if(arr[i].space<min){
  8016d4:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  8016d7:	89 d0                	mov    %edx,%eax
  8016d9:	01 c0                	add    %eax,%eax
  8016db:	01 d0                	add    %edx,%eax
  8016dd:	c1 e0 02             	shl    $0x2,%eax
  8016e0:	05 28 31 80 00       	add    $0x803128,%eax
  8016e5:	8b 00                	mov    (%eax),%eax
  8016e7:	3b 45 b8             	cmp    -0x48(%ebp),%eax
  8016ea:	7d 1c                	jge    801708 <malloc+0x374>
			//cprintf("arr %d size is: %x\n",i,min);
			min=arr[i].space;
  ...
  8016ff:	89 45 b8             	mov    %eax,-0x48(%ebp)
			index=i;
  801702:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801705:	89 45 bc             	mov    %eax,-0x44(%ebp)
		}
	}
	...
	int min=9999999;
	for(int i=0;i<count2;i++){
  801708:	ff 45 b4             	incl   -0x4c(%ebp)
  80170b:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  80170e:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801711:	7c c1                	jl     8016d4 <malloc+0x340>
			//cprintf("arr %d size is: %x\n",i,min);
  ...
  801713:	8b 15 28 30 80 00    	mov    0x803028,%edx
  801719:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  80171c:	89 c8                	mov    %ecx,%eax
  80171e:	01 c0                	add    %eax,%eax
  801720:	01 c8                	add    %ecx,%eax
  801722:	c1 e0 02             	shl    $0x2,%eax
  801725:	05 20 31 80 00       	add    $0x803120,%eax
  80172a:	8b 00                	mov    (%eax),%eax
  80172c:	89 04 d5 e0 05 82 00 	mov    %eax,0x8205e0(,%edx,8)
	arr_add[count].end=arr[index].end;
  801733:	8b 15 28 30 80 00    	mov    0x803028,%edx
  801739:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  80173c:	89 c8                	mov    %ecx,%eax
  80173e:	01 c0                	add    %eax,%eax
  801740:	01 c8                	add    %ecx,%eax
  801742:	c1 e0 02             	shl    $0x2,%eax
  801745:	05 24 31 80 00       	add    $0x803124,%eax
  80174a:	8b 00                	mov    (%eax),%eax
  80174c:	89 04 d5 e4 05 82 00 	mov    %eax,0x8205e4(,%edx,8)
	count++;
  801753:	a1 28 30 80 00       	mov    0x803028,%eax
  801758:	40                   	inc    %eax
  801759:	a3 28 30 80 00       	mov    %eax,0x803028


		sys_allocateMem(arr[index].start,size);
  80175e:	8b 55 bc             	mov    -0x44(%ebp),%edx
  801761:	89 d0                	mov    %edx,%eax
  801763:	01 c0                	add    %eax,%eax
  801765:	01 d0                	add    %edx,%eax
  801767:	c1 e0 02             	shl    $0x2,%eax
  80176a:	05 20 31 80 00       	add    $0x803120,%eax
  80176f:	8b 00                	mov    (%eax),%eax
  801771:	83 ec 08             	sub    $0x8,%esp
  801774:	ff 75 08             	pushl  0x8(%ebp)
  801777:	50                   	push   %eax
  801778:	e8 48 04 00 00       	call   801bc5 <sys_allocateMem>
  80177d:	83 c4 10             	add    $0x10,%esp

		for(int i=0;i<count2;i++){
  801780:	c7 45 b0 00 00 00 00 	movl   $0x0,-0x50(%ebp)
  801787:	eb 78                	jmp    801801 <malloc+0x46d>

			cprintf("arr %d start is: %x\n",i,arr[i].start);
  801789:	8b 55 b0             	mov    -0x50(%ebp),%edx
  ...
  80179f:	50                   	push   %eax
  8017a0:	ff 75 b0             	pushl  -0x50(%ebp)
  8017a3:	68 10 29 80 00       	push   $0x802910
  8017a8:	e8 5d ee ff ff       	call   80060a <cprintf>
  8017ad:	83 c4 10             	add    $0x10,%esp
			cprintf("arr %d end is: %x\n",i,arr[i].end);
  8017b0:	8b 55 b0             	mov    -0x50(%ebp),%edx
  8017b3:	89 d0                	mov    %edx,%eax
  8017b5:	01 c0                	add    %eax,%eax
  8017b7:	01 d0                	add    %edx,%eax
  8017b9:	c1 e0 02             	shl    $0x2,%eax
  8017bc:	05 24 31 80 00       	add    $0x803124,%eax
  8017c1:	8b 00                	mov    (%eax),%eax
  8017c3:	83 ec 04             	sub    $0x4,%esp
  8017c6:	50                   	push   %eax
  8017c7:	ff 75 b0             	pushl  -0x50(%ebp)
  8017ca:	68 25 29 80 00       	push   $0x802925
  8017cf:	e8 36 ee ff ff       	call   80060a <cprintf>
  8017d4:	83 c4 10             	add    $0x10,%esp
			cprintf("arr %d size is: %d\n",i,arr[i].space);
  8017d7:	8b 55 b0             	mov    -0x50(%ebp),%edx
  8017da:	89 d0                	mov    %edx,%eax
  8017dc:	01 c0                	add    %eax,%eax
  8017de:	01 d0                	add    %edx,%eax
  8017e0:	c1 e0 02             	shl    $0x2,%eax
  8017e3:	05 28 31 80 00       	add    $0x803128,%eax
  8017e8:	8b 00                	mov    (%eax),%eax
  8017ea:	83 ec 04             	sub    $0x4,%esp
  8017ed:	50                   	push   %eax
  8017ee:	ff 75 b0             	pushl  -0x50(%ebp)
  8017f1:	68 38 29 80 00       	push   $0x802938
  8017f6:	e8 0f ee ff ff       	call   80060a <cprintf>
  8017fb:	83 c4 10             	add    $0x10,%esp
	count++;
		...
		for(int i=0;i<count2;i++){
  8017fe:	ff 45 b0             	incl   -0x50(%ebp)
  801801:	8b 45 b0             	mov    -0x50(%ebp),%eax
  801804:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801807:	7c 80                	jl     801789 <malloc+0x3f5>
			cprintf("arr %d start is: %x\n",i,arr[i].start);
			cprintf("arr %d end is: %x\n",i,arr[i].end);
			cprintf("arr %d size is: %d\n",i,arr[i].space);
			}
...
void free(void* virtual_address)
{
  ...
  80184b:	89 45 e4             	mov    %eax,-0x1c(%ebp)

		int index;

		for(int i=0;i<count;i++){
  80184e:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801855:	eb 4b                	jmp    8018a2 <free+0x60>
			if((int)v>=(int)arr_add[i].start&&(int)v<(int)arr_add[i].end){
  801857:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80185a:	8b 04 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%eax
  801861:	89 c2                	mov    %eax,%edx
  801863:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801866:	39 c2                	cmp    %eax,%edx
  801868:	7f 35                	jg     80189f <free+0x5d>
  80186a:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80186d:	8b 04 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%eax
  801874:	89 c2                	mov    %eax,%edx
  801876:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801879:	39 c2                	cmp    %eax,%edx
  80187b:	7e 22                	jle    80189f <free+0x5d>
  ...
  80189d:	eb 0d                	jmp    8018ac <free+0x6a>
		...
		for(int i=0;i<count;i++){
  80189f:	ff 45 ec             	incl   -0x14(%ebp)
  8018a2:	a1 28 30 80 00       	mov    0x803028,%eax
  8018a7:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  8018aa:	7c ab                	jl     801857 <free+0x15>
				break;
			}
		}
  ...
  8018af:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  8018b6:	8b 45 f0             	mov    -0x10(%ebp),%eax
  8018b9:	8b 04 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%eax
  8018c0:	29 c2                	sub    %eax,%edx
  8018c2:	89 d0                	mov    %edx,%eax
  8018c4:	83 ec 08             	sub    $0x8,%esp
  8018c7:	50                   	push   %eax
  8018c8:	ff 75 f4             	pushl  -0xc(%ebp)
  8018cb:	e8 d9 02 00 00       	call   801ba9 <sys_freeMem>
  ...
  8018d9:	eb 2d                	jmp    801908 <free+0xc6>
			arr_add[i].start=arr_add[i+1].start;
  8018db:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018de:	40                   	inc    %eax
  8018df:	8b 14 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%edx
  8018e6:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018e9:	89 14 c5 e0 05 82 00 	mov    %edx,0x8205e0(,%eax,8)
			arr_add[i].end=arr_add[i+1].end;
  8018f0:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018f3:	40                   	inc    %eax
  8018f4:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  8018fb:	8b 45 e8             	mov    -0x18(%ebp),%eax
  8018fe:	89 14 c5 e4 05 82 00 	mov    %edx,0x8205e4(,%eax,8)
  ...
  801908:	a1 28 30 80 00       	mov    0x803028,%eax
  80190d:	48                   	dec    %eax
  80190e:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801911:	7f c8                	jg     8018db <free+0x99>
			arr_add[i].start=arr_add[i+1].start;
			arr_add[i].end=arr_add[i+1].end;
		}
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  80192a:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  80192d:	83 ec 04             	sub    $0x4,%esp
  801930:	68 68 29 80 00       	push   $0x802968
  801935:	68 18 01 00 00       	push   $0x118
  80193a:	68 8b 29 80 00       	push   $0x80298b
  80193f:	e8 24 ea ff ff       	call   800368 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  80194d:	68 68 29 80 00       	push   $0x802968
  801952:	68 1e 01 00 00       	push   $0x11e
  801957:	68 8b 29 80 00       	push   $0x80298b
  80195c:	e8 07 ea ff ff       	call   800368 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  80196a:	68 68 29 80 00       	push   $0x802968
  80196f:	68 24 01 00 00       	push   $0x124
  801974:	68 8b 29 80 00       	push   $0x80298b
  801979:	e8 ea e9 ff ff       	call   800368 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  80198c:	68 29 01 00 00       	push   $0x129
  801991:	68 8b 29 80 00       	push   $0x80298b
  801996:	e8 cd e9 ff ff       	call   800368 <_panic>
...
void expand(uint32 newSize)
{
  ...
  8019a4:	68 68 29 80 00       	push   $0x802968
  8019a9:	68 2f 01 00 00       	push   $0x12f
  8019ae:	68 8b 29 80 00       	push   $0x80298b
  8019b3:	e8 b0 e9 ff ff       	call   800368 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  8019c1:	68 68 29 80 00       	push   $0x802968
  8019c6:	68 33 01 00 00       	push   $0x133
  8019cb:	68 8b 29 80 00       	push   $0x80298b
  8019d0:	e8 93 e9 ff ff       	call   800368 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  8019de:	68 68 29 80 00       	push   $0x802968
  8019e3:	68 38 01 00 00       	push   $0x138
  8019e8:	68 8b 29 80 00       	push   $0x80298b
  8019ed:	e8 76 e9 ff ff       	call   800368 <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801a07:	8b 7d 18             	mov    0x18(%ebp),%edi
  801a0a:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801a3b:	e8 b2 ff ff ff       	call   8019f2 <syscall>
...
sys_cgetc(void)
{
  ...
  801a55:	e8 98 ff ff ff       	call   8019f2 <syscall>
...
int sys_env_destroy(int32  envid)
{
  ...
  801a6d:	50                   	push   %eax
  801a6e:	6a 05                	push   $0x5
  801a70:	e8 7d ff ff ff       	call   8019f2 <syscall>
  801a75:	83 c4 18             	add    $0x18,%esp
}
  801a78:	c9                   	leave  
  801a79:	c3                   	ret    

00801a7a <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801a89:	e8 64 ff ff ff       	call   8019f2 <syscall>
  801a8e:	83 c4 18             	add    $0x18,%esp
}
  801a91:	c9                   	leave  
  801a92:	c3                   	ret    

00801a93 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801aa0:	6a 03                	push   $0x3
  801aa2:	e8 4b ff ff ff       	call   8019f2 <syscall>
  801aa7:	83 c4 18             	add    $0x18,%esp
}
  801aaa:	c9                   	leave  
  801aab:	c3                   	ret    

00801aac <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801ab9:	6a 04                	push   $0x4
  801abb:	e8 32 ff ff ff       	call   8019f2 <syscall>
  801ac0:	83 c4 18             	add    $0x18,%esp
}
  801ac3:	c9                   	leave  
  801ac4:	c3                   	ret    

00801ac5 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801ad2:	6a 06                	push   $0x6
  801ad4:	e8 19 ff ff ff       	call   8019f2 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801af2:	e8 fb fe ff ff       	call   8019f2 <syscall>
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801b13:	52                   	push   %edx
  801b14:	50                   	push   %eax
  801b15:	6a 08                	push   $0x8
  801b17:	e8 d6 fe ff ff       	call   8019f2 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801b39:	e8 b4 fe ff ff       	call   8019f2 <syscall>
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801b54:	e8 99 fe ff ff       	call   8019f2 <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  801b6d:	e8 80 fe ff ff       	call   8019f2 <syscall>
...
uint32 sys_calculate_modified_frames()
{
  ...
  801b84:	6a 0c                	push   $0xc
  801b86:	e8 67 fe ff ff       	call   8019f2 <syscall>
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801b9d:	6a 0d                	push   $0xd
  801b9f:	e8 4e fe ff ff       	call   8019f2 <syscall>
  801ba4:	83 c4 18             	add    $0x18,%esp
}
  801ba7:	c9                   	leave  
  801ba8:	c3                   	ret    

00801ba9 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801bb8:	6a 11                	push   $0x11
  801bba:	e8 33 fe ff ff       	call   8019f2 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801bd4:	6a 12                	push   $0x12
  801bd6:	e8 17 fe ff ff       	call   8019f2 <syscall>
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801bee:	6a 0e                	push   $0xe
  801bf0:	e8 fd fd ff ff       	call   8019f2 <syscall>
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801c08:	6a 0f                	push   $0xf
  801c0a:	e8 e3 fd ff ff       	call   8019f2 <syscall>
...
void sys_scarce_memory()
{
  ...
  801c21:	6a 10                	push   $0x10
  801c23:	e8 ca fd ff ff       	call   8019f2 <syscall>
...
00801c2e <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801c3d:	e8 b0 fd ff ff       	call   8019f2 <syscall>
...
sys_enable_interrupt()
{
  ...
  801c55:	6a 15                	push   $0x15
  801c57:	e8 96 fd ff ff       	call   8019f2 <syscall>
...
sys_cputc(const char c)
{
  ...
  801c6e:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  ...
  801c7d:	e8 70 fd ff ff       	call   8019f2 <syscall>
...
sys_clear_ffl()
{
  ...
  801c95:	6a 17                	push   $0x17
  801c97:	e8 56 fd ff ff       	call   8019f2 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  801cb1:	50                   	push   %eax
  801cb2:	6a 18                	push   $0x18
  801cb4:	e8 39 fd ff ff       	call   8019f2 <syscall>
  801cb9:	83 c4 18             	add    $0x18,%esp
}
  801cbc:	c9                   	leave  
  801cbd:	c3                   	ret    

00801cbe <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801cd1:	e8 1c fd ff ff       	call   8019f2 <syscall>
  801cd6:	83 c4 18             	add    $0x18,%esp
}
  801cd9:	c9                   	leave  
  801cda:	c3                   	ret    

00801cdb <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801cee:	e8 ff fc ff ff       	call   8019f2 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  801d08:	52                   	push   %edx
  801d09:	50                   	push   %eax
  801d0a:	6a 1a                	push   $0x1a
  801d0c:	e8 e1 fc ff ff       	call   8019f2 <syscall>
...
00801d17 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  801d23:	8b 4d 14             	mov    0x14(%ebp),%ecx
  ...
  801d34:	50                   	push   %eax
  801d35:	6a 1c                	push   $0x1c
  801d37:	e8 b6 fc ff ff       	call   8019f2 <syscall>
  801d3c:	83 c4 18             	add    $0x18,%esp
}
  801d3f:	c9                   	leave  
  801d40:	c3                   	ret    

00801d41 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  801d50:	52                   	push   %edx
  801d51:	50                   	push   %eax
  801d52:	6a 1d                	push   $0x1d
  801d54:	e8 99 fc ff ff       	call   8019f2 <syscall>
  801d59:	83 c4 18             	add    $0x18,%esp
}
  801d5c:	c9                   	leave  
  801d5d:	c3                   	ret    

00801d5e <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  801d6f:	52                   	push   %edx
  801d70:	50                   	push   %eax
  801d71:	6a 1e                	push   $0x1e
  801d73:	e8 7a fc ff ff       	call   8019f2 <syscall>
  801d78:	83 c4 18             	add    $0x18,%esp
}
  801d7b:	c9                   	leave  
  801d7c:	c3                   	ret    

00801d7d <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  801d90:	e8 5d fc ff ff       	call   8019f2 <syscall>
  801d95:	83 c4 18             	add    $0x18,%esp
}
  801d98:	c9                   	leave  
  801d99:	c3                   	ret    

00801d9a <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  801da9:	e8 44 fc ff ff       	call   8019f2 <syscall>
  801dae:	83 c4 18             	add    $0x18,%esp
}
  801db1:	c9                   	leave  
  801db2:	c3                   	ret    

00801db3 <sys_create_env>:
...
sys_run_env(int32 envId)
{
  ...
  801de2:	e8 0b fc ff ff       	call   8019f2 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  801dfe:	e8 ef fb ff ff       	call   8019f2 <syscall>
...
sys_get_virtual_time()
{
  ...
  801e1e:	52                   	push   %edx
  801e1f:	50                   	push   %eax
  801e20:	6a 24                	push   $0x24
  801e22:	e8 cb fb ff ff       	call   8019f2 <syscall>
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  801e51:	e8 9c fb ff ff       	call   8019f2 <syscall>
...
uint32 sys_rcr2()
{
  ...
  801e69:	6a 25                	push   $0x25
  801e6b:	e8 82 fb ff ff       	call   8019f2 <syscall>
...
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  801e8d:	50                   	push   %eax
  801e8e:	6a 26                	push   $0x26
  801e90:	e8 5d fb ff ff       	call   8019f2 <syscall>
...
void rsttst()
{
  ...
  801ea8:	6a 28                	push   $0x28
  801eaa:	e8 43 fb ff ff       	call   8019f2 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  801ed3:	6a 27                	push   $0x27
  801ed5:	e8 18 fb ff ff       	call   8019f2 <syscall>
...
void chktst(uint32 n)
{
  ...
  801ef0:	e8 fd fa ff ff       	call   8019f2 <syscall>
...
void inctst()
{
  ...
  801f08:	6a 2a                	push   $0x2a
  801f0a:	e8 e3 fa ff ff       	call   8019f2 <syscall>
...
uint32 gettst()
{
  ...
  801f22:	6a 2b                	push   $0x2b
  801f24:	e8 c9 fa ff ff       	call   8019f2 <syscall>
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  801f40:	e8 ad fa ff ff       	call   8019f2 <syscall>
...
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  801f71:	e8 7c fa ff ff       	call   8019f2 <syscall>
...
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  801fa2:	e8 4b fa ff ff       	call   8019f2 <syscall>
...
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  ...
  801fd3:	e8 1a fa ff ff       	call   8019f2 <syscall>
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  802002:	e8 eb f9 ff ff       	call   8019f2 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  802021:	52                   	push   %edx
  802022:	50                   	push   %eax
  802023:	6a 2e                	push   $0x2e
  802025:	e8 c8 f9 ff ff       	call   8019f2 <syscall>
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  802041:	52                   	push   %edx
  802042:	50                   	push   %eax
  802043:	6a 2f                	push   $0x2f
  802045:	e8 a8 f9 ff ff       	call   8019f2 <syscall>
...
00802050 <__udivdi3>:
  ...
  8020a2:	77 28                	ja     8020cc <__udivdi3+0x7c>
  8020a4:	0f bd fe             	bsr    %esi,%edi
  8020a7:	83 f7 1f             	xor    $0x1f,%edi
  8020aa:	75 40                	jne    8020ec <__udivdi3+0x9c>
  8020ac:	39 ce                	cmp    %ecx,%esi
  8020ae:	72 0a                	jb     8020ba <__udivdi3+0x6a>
  8020b0:	3b 44 24 08          	cmp    0x8(%esp),%eax
  8020b4:	0f 87 9e 00 00 00    	ja     802158 <__udivdi3+0x108>
  ...
  8020ea:	5d                   	pop    %ebp
  8020eb:	c3                   	ret    
  8020ec:	bd 20 00 00 00       	mov    $0x20,%ebp
  8020f1:	89 eb                	mov    %ebp,%ebx
  8020f3:	29 fb                	sub    %edi,%ebx
  8020f5:	89 f9                	mov    %edi,%ecx
  8020f7:	d3 e6                	shl    %cl,%esi
  8020f9:	89 c5                	mov    %eax,%ebp
  8020fb:	88 d9                	mov    %bl,%cl
  8020fd:	d3 ed                	shr    %cl,%ebp
  8020ff:	89 e9                	mov    %ebp,%ecx
  802101:	09 f1                	or     %esi,%ecx
  802103:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  802107:	89 f9                	mov    %edi,%ecx
  802109:	d3 e0                	shl    %cl,%eax
  80210b:	89 c5                	mov    %eax,%ebp
  80210d:	89 d6                	mov    %edx,%esi
  80210f:	88 d9                	mov    %bl,%cl
  802111:	d3 ee                	shr    %cl,%esi
  802113:	89 f9                	mov    %edi,%ecx
  802115:	d3 e2                	shl    %cl,%edx
  802117:	8b 44 24 08          	mov    0x8(%esp),%eax
  80211b:	88 d9                	mov    %bl,%cl
  80211d:	d3 e8                	shr    %cl,%eax
  80211f:	09 c2                	or     %eax,%edx
  802121:	89 d0                	mov    %edx,%eax
  802123:	89 f2                	mov    %esi,%edx
  802125:	f7 74 24 0c          	divl   0xc(%esp)
  802129:	89 d6                	mov    %edx,%esi
  80212b:	89 c3                	mov    %eax,%ebx
  80212d:	f7 e5                	mul    %ebp
  80212f:	39 d6                	cmp    %edx,%esi
  802131:	72 19                	jb     80214c <__udivdi3+0xfc>
  802133:	74 0b                	je     802140 <__udivdi3+0xf0>
  802135:	89 d8                	mov    %ebx,%eax
  802137:	31 ff                	xor    %edi,%edi
  802139:	e9 58 ff ff ff       	jmp    802096 <__udivdi3+0x46>
  80213e:	66 90                	xchg   %ax,%ax
  802140:	8b 54 24 08          	mov    0x8(%esp),%edx
  802144:	89 f9                	mov    %edi,%ecx
  802146:	d3 e2                	shl    %cl,%edx
  802148:	39 c2                	cmp    %eax,%edx
  80214a:	73 e9                	jae    802135 <__udivdi3+0xe5>
  80214c:	8d 43 ff             	lea    -0x1(%ebx),%eax
  80214f:	31 ff                	xor    %edi,%edi
  802151:	e9 40 ff ff ff       	jmp    802096 <__udivdi3+0x46>
  802156:	66 90                	xchg   %ax,%ax
  802158:	31 c0                	xor    %eax,%eax
  80215a:	e9 37 ff ff ff       	jmp    802096 <__udivdi3+0x46>
  80215f:	90                   	nop
...
00802160 <__umoddi3>:
  ...
  802167:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  80216b:	8b 74 24 34          	mov    0x34(%esp),%esi
  80216f:	8b 7c 24 38          	mov    0x38(%esp),%edi
  802173:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  802177:	89 44 24 0c          	mov    %eax,0xc(%esp)
  80217b:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  80217f:	89 f3                	mov    %esi,%ebx
  802181:	89 fa                	mov    %edi,%edx
  802183:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802187:	89 34 24             	mov    %esi,(%esp)
  80218a:	85 c0                	test   %eax,%eax
  80218c:	75 1a                	jne    8021a8 <__umoddi3+0x48>
  80218e:	39 f7                	cmp    %esi,%edi
  802190:	0f 86 a2 00 00 00    	jbe    802238 <__umoddi3+0xd8>
  ...
  8021aa:	0f 87 ac 00 00 00    	ja     80225c <__umoddi3+0xfc>
  8021b0:	0f bd e8             	bsr    %eax,%ebp
  8021b3:	83 f5 1f             	xor    $0x1f,%ebp
  8021b6:	0f 84 ac 00 00 00    	je     802268 <__umoddi3+0x108>
  8021bc:	bf 20 00 00 00       	mov    $0x20,%edi
  8021c1:	29 ef                	sub    %ebp,%edi
  8021c3:	89 fe                	mov    %edi,%esi
  8021c5:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  8021c9:	89 e9                	mov    %ebp,%ecx
  8021cb:	d3 e0                	shl    %cl,%eax
  8021cd:	89 d7                	mov    %edx,%edi
  8021cf:	89 f1                	mov    %esi,%ecx
  8021d1:	d3 ef                	shr    %cl,%edi
  8021d3:	09 c7                	or     %eax,%edi
  ...
  8021e2:	8b 44 24 08          	mov    0x8(%esp),%eax
  8021e6:	d3 e0                	shl    %cl,%eax
  8021e8:	89 44 24 04          	mov    %eax,0x4(%esp)
  8021ec:	8b 44 24 08          	mov    0x8(%esp),%eax
  8021f0:	89 f1                	mov    %esi,%ecx
  8021f2:	d3 e8                	shr    %cl,%eax
  8021f4:	09 d0                	or     %edx,%eax
  8021f6:	d3 eb                	shr    %cl,%ebx
  8021f8:	89 da                	mov    %ebx,%edx
  8021fa:	f7 f7                	div    %edi
  8021fc:	89 d3                	mov    %edx,%ebx
  8021fe:	f7 24 24             	mull   (%esp)
  802201:	89 c6                	mov    %eax,%esi
  802203:	89 d1                	mov    %edx,%ecx
  802205:	39 d3                	cmp    %edx,%ebx
  802207:	0f 82 87 00 00 00    	jb     802294 <__umoddi3+0x134>
  80220d:	0f 84 91 00 00 00    	je     8022a4 <__umoddi3+0x144>
  802213:	8b 54 24 04          	mov    0x4(%esp),%edx
  802217:	29 f2                	sub    %esi,%edx
  802219:	19 cb                	sbb    %ecx,%ebx
  80221b:	89 d8                	mov    %ebx,%eax
  80221d:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  802221:	d3 e0                	shl    %cl,%eax
  802223:	89 e9                	mov    %ebp,%ecx
  802225:	d3 ea                	shr    %cl,%edx
  802227:	09 d0                	or     %edx,%eax
  802229:	89 e9                	mov    %ebp,%ecx
  80222b:	d3 eb                	shr    %cl,%ebx
  ...
  80223c:	75 0b                	jne    802249 <__umoddi3+0xe9>
  ...
  802255:	e9 44 ff ff ff       	jmp    80219e <__umoddi3+0x3e>
  ...
  802266:	5d                   	pop    %ebp
  802267:	c3                   	ret    
  802268:	3b 04 24             	cmp    (%esp),%eax
  80226b:	72 06                	jb     802273 <__umoddi3+0x113>
  80226d:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  802271:	77 0f                	ja     802282 <__umoddi3+0x122>
  802273:	89 f2                	mov    %esi,%edx
  802275:	29 f9                	sub    %edi,%ecx
  802277:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  80227b:	89 14 24             	mov    %edx,(%esp)
  80227e:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802282:	8b 44 24 04          	mov    0x4(%esp),%eax
  802286:	8b 14 24             	mov    (%esp),%edx
  ...
  802294:	2b 04 24             	sub    (%esp),%eax
  802297:	19 fa                	sbb    %edi,%edx
  802299:	89 d1                	mov    %edx,%ecx
  80229b:	89 c6                	mov    %eax,%esi
  80229d:	e9 71 ff ff ff       	jmp    802213 <__umoddi3+0xb3>
  8022a2:	66 90                	xchg   %ax,%ax
  8022a4:	39 44 24 04          	cmp    %eax,0x4(%esp)
  8022a8:	72 ea                	jb     802294 <__umoddi3+0x134>
  8022aa:	89 d9                	mov    %ebx,%ecx
  8022ac:	e9 62 ff ff ff       	jmp    802213 <__umoddi3+0xb3>

...
libmain(int argc, char **argv)
{
  ...
  8003a9:	e8 65 18 00 00       	call   801c13 <sys_getenvindex>
  ...
  800426:	e8 83 19 00 00       	call   801dae <sys_disable_interrupt>
	cprintf("**************************************\n");
  ...
  8004b7:	e8 0c 19 00 00       	call   801dc8 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8004cf:	e8 0b 17 00 00       	call   801bdf <sys_env_destroy>
...
exit(void)
{
  ...
  8004dd:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8004e0:	e8 60 17 00 00       	call   801c45 <sys_env_exit>
}
  8004e5:	90                   	nop
  8004e6:	c9                   	leave  
  8004e7:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  8006fa:	51                   	push   %ecx
  8006fb:	52                   	push   %edx
  8006fc:	e8 9c 14 00 00       	call   801b9d <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800772:	50                   	push   %eax
  800773:	e8 25 14 00 00       	call   801b9d <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8007ba:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8007bd:	e8 ec 15 00 00       	call   801dae <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8007da:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8007dd:	e8 e6 15 00 00       	call   801dc8 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800827:	e8 a4 19 00 00       	call   8021d0 <__udivdi3>
  ...
  800875:	52                   	push   %edx
  800876:	50                   	push   %eax
  800877:	e8 64 1a 00 00       	call   8022e0 <__umoddi3>
...
//	while(size%PAGE_SIZE!=0){
  ...
  8015da:	77 21                	ja     8015fd <malloc+0xe9>
  ...
  8015eb:	76 10                	jbe    8015fd <malloc+0xe9>
					ni=PAGE_SIZE;
  8015ed:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%ebp)
					flag1=1;
  8015f4:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
					break;
  8015fb:	eb 0d                	jmp    80160a <malloc+0xf6>
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		...
		for(int j=i;j<i+size;j+=PAGE_SIZE){
			for(int k=0;k<count;k++){
  8015fd:	ff 45 d8             	incl   -0x28(%ebp)
  801600:	a1 28 30 80 00       	mov    0x803028,%eax
  801605:	39 45 d8             	cmp    %eax,-0x28(%ebp)
  801608:	7c c1                	jl     8015cb <malloc+0xb7>
					ni=PAGE_SIZE;
					flag1=1;
					break;
				}
			...
			if(flag1){
  80160a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  80160e:	74 09                	je     801619 <malloc+0x105>
				flag0=0;
  801610:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
				break;
  801617:	eb 16                	jmp    80162f <malloc+0x11b>
		cprintf("arr %d end is: %x\n",i,arr_add[i].end);
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		int flag0=1;
		for(int j=i;j<i+size;j+=PAGE_SIZE){
  801619:	81 45 dc 00 10 00 00 	addl   $0x1000,-0x24(%ebp)
  801620:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801623:	8b 45 08             	mov    0x8(%ebp),%eax
  801626:	01 c2                	add    %eax,%edx
  801628:	8b 45 dc             	mov    -0x24(%ebp),%eax
  80162b:	39 c2                	cmp    %eax,%edx
  80162d:	77 93                	ja     8015c2 <malloc+0xae>
			if(flag1){
				flag0=0;
				break;
			}
		...
		if(flag0){
  80162f:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  801633:	0f 84 a2 00 00 00    	je     8016db <malloc+0x1c7>

			int f=1;
  801639:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)

			arr[count2].start=i;
  801640:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801643:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801646:	89 c8                	mov    %ecx,%eax
  801648:	01 c0                	add    %eax,%eax
  80164a:	01 c8                	add    %ecx,%eax
  80164c:	c1 e0 02             	shl    $0x2,%eax
  80164f:	05 20 31 80 00       	add    $0x803120,%eax
  801654:	89 10                	mov    %edx,(%eax)
			arr[count2].end = i+size;
  801656:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801659:	8b 45 08             	mov    0x8(%ebp),%eax
  80165c:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
  ...
  80166b:	05 24 31 80 00       	add    $0x803124,%eax
  ...
  80168c:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
  801693:	eb 36                	jmp    8016cb <malloc+0x1b7>
				if(i+size<arr_add[l].start){
  801695:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801698:	8b 45 08             	mov    0x8(%ebp),%eax
  80169b:	01 c2                	add    %eax,%edx
  80169d:	8b 45 d0             	mov    -0x30(%ebp),%eax
  8016a0:	8b 04 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%eax
  8016a7:	39 c2                	cmp    %eax,%edx
  8016a9:	73 1d                	jae    8016c8 <malloc+0x1b4>
					ni=arr_add[l].end-i;
  8016ab:	8b 45 d0             	mov    -0x30(%ebp),%eax
  8016ae:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  8016b5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8016b8:	29 c2                	sub    %eax,%edx
  8016ba:	89 d0                	mov    %edx,%eax
  8016bc:	89 45 ec             	mov    %eax,-0x14(%ebp)
					f=0;
  8016bf:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					break;
  8016c6:	eb 0d                	jmp    8016d5 <malloc+0x1c1>
			arr[count2].start=i;
			arr[count2].end = i+size;
			arr[count2].space=0;
			count2++;
			...
			for(int l=0;l<count;l++){
  8016c8:	ff 45 d0             	incl   -0x30(%ebp)
  8016cb:	a1 28 30 80 00       	mov    0x803028,%eax
  8016d0:	39 45 d0             	cmp    %eax,-0x30(%ebp)
  8016d3:	7c c0                	jl     801695 <malloc+0x181>
					break;
			...
			if(f){
  8016d5:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  8016d9:	75 1d                	jne    8016f8 <malloc+0x1e4>
				break;
			}
		...
		flag1=0;
  8016db:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  ...
  8016e5:	01 45 e4             	add    %eax,-0x1c(%ebp)
  8016e8:	a1 04 30 80 00       	mov    0x803004,%eax
  8016ed:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  8016f0:	0f 8c bd fe ff ff    	jl     8015b3 <malloc+0x9f>
  8016f6:	eb 01                	jmp    8016f9 <malloc+0x1e5>
  ...
  8016f8:	90                   	nop
	...
	if(count2==0){
  8016f9:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
  8016fd:	75 7a                	jne    801779 <malloc+0x265>
		//cprintf("hellllllllOOlooo");
		if((int)(base_add+size-1)>=(int)USER_HEAP_MAX)
  8016ff:	8b 15 04 30 80 00    	mov    0x803004,%edx
  801705:	8b 45 08             	mov    0x8(%ebp),%eax
  801708:	01 d0                	add    %edx,%eax
  80170a:	48                   	dec    %eax
  80170b:	3d 00 00 00 a0       	cmp    $0xa0000000,%eax
  801710:	7c 0a                	jl     80171c <malloc+0x208>
			return NULL;
  801712:	b8 00 00 00 00       	mov    $0x0,%eax
  801717:	e9 a4 02 00 00       	jmp    8019c0 <malloc+0x4ac>
		else{
			uint32 s=base_add;
  80171c:	a1 04 30 80 00       	mov    0x803004,%eax
  801721:	89 45 a4             	mov    %eax,-0x5c(%ebp)
			//cprintf("s: %x",s);
			arr_add[count].start=s;
  801724:	a1 28 30 80 00       	mov    0x803028,%eax
  801729:	8b 55 a4             	mov    -0x5c(%ebp),%edx
  80172c:	89 14 c5 e0 05 82 00 	mov    %edx,0x8205e0(,%eax,8)
		    sys_allocateMem(s,size);
  801733:	83 ec 08             	sub    $0x8,%esp
  801736:	ff 75 08             	pushl  0x8(%ebp)
  801739:	ff 75 a4             	pushl  -0x5c(%ebp)
  80173c:	e8 04 06 00 00       	call   801d45 <sys_allocateMem>
  801741:	83 c4 10             	add    $0x10,%esp
			base_add+=size;
  801744:	8b 15 04 30 80 00    	mov    0x803004,%edx
  80174a:	8b 45 08             	mov    0x8(%ebp),%eax
  80174d:	01 d0                	add    %edx,%eax
  80174f:	a3 04 30 80 00       	mov    %eax,0x803004
			arr_add[count].end=base_add;
  801754:	a1 28 30 80 00       	mov    0x803028,%eax
  801759:	8b 15 04 30 80 00    	mov    0x803004,%edx
  80175f:	89 14 c5 e4 05 82 00 	mov    %edx,0x8205e4(,%eax,8)
			count++;
  801766:	a1 28 30 80 00       	mov    0x803028,%eax
  80176b:	40                   	inc    %eax
  80176c:	a3 28 30 80 00       	mov    %eax,0x803028

			return (void*)s;
  801771:	8b 45 a4             	mov    -0x5c(%ebp),%eax
  801774:	e9 47 02 00 00       	jmp    8019c0 <malloc+0x4ac>
	}
	else{
  ...
  801779:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%ebp)
  801780:	e9 ac 00 00 00       	jmp    801831 <malloc+0x31d>
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801785:	8b 55 cc             	mov    -0x34(%ebp),%edx
  ...
  801798:	89 45 c8             	mov    %eax,-0x38(%ebp)
  80179b:	eb 7e                	jmp    80181b <malloc+0x307>
			int flag=0;
  80179d:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
			for(int k=0;k<count;k++){
  8017a4:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
  8017ab:	eb 57                	jmp    801804 <malloc+0x2f0>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
  8017ad:	8b 45 c0             	mov    -0x40(%ebp),%eax
  8017b0:	8b 14 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%edx
  8017b7:	8b 45 c8             	mov    -0x38(%ebp),%eax
  8017ba:	39 c2                	cmp    %eax,%edx
  8017bc:	77 1a                	ja     8017d8 <malloc+0x2c4>
  8017be:	8b 45 c0             	mov    -0x40(%ebp),%eax
  8017c1:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  8017c8:	8b 45 c8             	mov    -0x38(%ebp),%eax
  8017cb:	39 c2                	cmp    %eax,%edx
  8017cd:	76 09                	jbe    8017d8 <malloc+0x2c4>
								flag=1;
  8017cf:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
								break;}
  8017d6:	eb 36                	jmp    80180e <malloc+0x2fa>
			arr[i].space++;
  8017d8:	8b 55 cc             	mov    -0x34(%ebp),%edx
  8017db:	89 d0                	mov    %edx,%eax
  8017dd:	01 c0                	add    %eax,%eax
  8017df:	01 d0                	add    %edx,%eax
  8017e1:	c1 e0 02             	shl    $0x2,%eax
  8017e4:	05 28 31 80 00       	add    $0x803128,%eax
  8017e9:	8b 00                	mov    (%eax),%eax
  8017eb:	8d 48 01             	lea    0x1(%eax),%ecx
  8017ee:	8b 55 cc             	mov    -0x34(%ebp),%edx
  8017f1:	89 d0                	mov    %edx,%eax
  8017f3:	01 c0                	add    %eax,%eax
  8017f5:	01 d0                	add    %edx,%eax
  8017f7:	c1 e0 02             	shl    $0x2,%eax
  8017fa:	05 28 31 80 00       	add    $0x803128,%eax
  8017ff:	89 08                	mov    %ecx,(%eax)
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
			int flag=0;
			for(int k=0;k<count;k++){
  801801:	ff 45 c0             	incl   -0x40(%ebp)
  801804:	a1 28 30 80 00       	mov    0x803028,%eax
  801809:	39 45 c0             	cmp    %eax,-0x40(%ebp)
  80180c:	7c 9f                	jl     8017ad <malloc+0x299>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
								flag=1;
								break;}
			arr[i].space++;
			...
			if(flag)
  80180e:	83 7d c4 00          	cmpl   $0x0,-0x3c(%ebp)
  801812:	75 19                	jne    80182d <malloc+0x319>
	else{
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801814:	81 45 c8 00 10 00 00 	addl   $0x1000,-0x38(%ebp)
  80181b:	8b 55 c8             	mov    -0x38(%ebp),%edx
  80181e:	a1 04 30 80 00       	mov    0x803004,%eax
  801823:	39 c2                	cmp    %eax,%edx
  801825:	0f 82 72 ff ff ff    	jb     80179d <malloc+0x289>
  80182b:	eb 01                	jmp    80182e <malloc+0x31a>
								flag=1;
								break;}
			arr[i].space++;
			}
  ...
  80182d:	90                   	nop
	...
	for(int i=0;i<count2;i++){
  80182e:	ff 45 cc             	incl   -0x34(%ebp)
  801831:	8b 45 cc             	mov    -0x34(%ebp),%eax
  801834:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801837:	0f 8c 48 ff ff ff    	jl     801785 <malloc+0x271>
			if(flag)
				break;
		}
	}
	...
	int index=0;
  80183d:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
	int min=9999999;
  801844:	c7 45 b8 7f 96 98 00 	movl   $0x98967f,-0x48(%ebp)
	for(int i=0;i<count2;i++){
  80184b:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
  801852:	eb 37                	jmp    80188b <malloc+0x377>
		//cprintf("arr %d size is: %x\n",i,arr[i].space);
		if(arr[i].space<min){
  801854:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  ...
  801867:	3b 45 b8             	cmp    -0x48(%ebp),%eax
  80186a:	7d 1c                	jge    801888 <malloc+0x374>
			//cprintf("arr %d size is: %x\n",i,min);
			min=arr[i].space;
  80186c:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  80186f:	89 d0                	mov    %edx,%eax
  801871:	01 c0                	add    %eax,%eax
  801873:	01 d0                	add    %edx,%eax
  801875:	c1 e0 02             	shl    $0x2,%eax
  801878:	05 28 31 80 00       	add    $0x803128,%eax
  80187d:	8b 00                	mov    (%eax),%eax
  80187f:	89 45 b8             	mov    %eax,-0x48(%ebp)
			index=i;
  801882:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801885:	89 45 bc             	mov    %eax,-0x44(%ebp)
		}
	}
	...
	int min=9999999;
	for(int i=0;i<count2;i++){
  801888:	ff 45 b4             	incl   -0x4c(%ebp)
  80188b:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  80188e:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801891:	7c c1                	jl     801854 <malloc+0x340>
			//cprintf("arr %d size is: %x\n",i,min);
  ...
  801893:	8b 15 28 30 80 00    	mov    0x803028,%edx
  801899:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  80189c:	89 c8                	mov    %ecx,%eax
  80189e:	01 c0                	add    %eax,%eax
  8018a0:	01 c8                	add    %ecx,%eax
  8018a2:	c1 e0 02             	shl    $0x2,%eax
  8018a5:	05 20 31 80 00       	add    $0x803120,%eax
  8018aa:	8b 00                	mov    (%eax),%eax
  8018ac:	89 04 d5 e0 05 82 00 	mov    %eax,0x8205e0(,%edx,8)
	arr_add[count].end=arr[index].end;
  8018b3:	8b 15 28 30 80 00    	mov    0x803028,%edx
  8018b9:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  8018bc:	89 c8                	mov    %ecx,%eax
  8018be:	01 c0                	add    %eax,%eax
  8018c0:	01 c8                	add    %ecx,%eax
  8018c2:	c1 e0 02             	shl    $0x2,%eax
  8018c5:	05 24 31 80 00       	add    $0x803124,%eax
  8018ca:	8b 00                	mov    (%eax),%eax
  8018cc:	89 04 d5 e4 05 82 00 	mov    %eax,0x8205e4(,%edx,8)
	count++;
  8018d3:	a1 28 30 80 00       	mov    0x803028,%eax
  8018d8:	40                   	inc    %eax
  8018d9:	a3 28 30 80 00       	mov    %eax,0x803028


		sys_allocateMem(arr[index].start,size);
  8018de:	8b 55 bc             	mov    -0x44(%ebp),%edx
  8018e1:	89 d0                	mov    %edx,%eax
  8018e3:	01 c0                	add    %eax,%eax
  8018e5:	01 d0                	add    %edx,%eax
  8018e7:	c1 e0 02             	shl    $0x2,%eax
  8018ea:	05 20 31 80 00       	add    $0x803120,%eax
  8018ef:	8b 00                	mov    (%eax),%eax
  8018f1:	83 ec 08             	sub    $0x8,%esp
  8018f4:	ff 75 08             	pushl  0x8(%ebp)
  8018f7:	50                   	push   %eax
  8018f8:	e8 48 04 00 00       	call   801d45 <sys_allocateMem>
  8018fd:	83 c4 10             	add    $0x10,%esp

		for(int i=0;i<count2;i++){
  801900:	c7 45 b0 00 00 00 00 	movl   $0x0,-0x50(%ebp)
  801907:	eb 78                	jmp    801981 <malloc+0x46d>
  ...
  80196d:	50                   	push   %eax
  80196e:	ff 75 b0             	pushl  -0x50(%ebp)
  801971:	68 78 2a 80 00       	push   $0x802a78
  801976:	e8 0f ee ff ff       	call   80078a <cprintf>
  80197b:	83 c4 10             	add    $0x10,%esp
	count++;
		...
		for(int i=0;i<count2;i++){
  80197e:	ff 45 b0             	incl   -0x50(%ebp)
  801981:	8b 45 b0             	mov    -0x50(%ebp),%eax
  801984:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801987:	7c 80                	jl     801909 <malloc+0x3f5>
			cprintf("arr %d start is: %x\n",i,arr[i].start);
			cprintf("arr %d end is: %x\n",i,arr[i].end);
			cprintf("arr %d size is: %d\n",i,arr[i].space);
			}
...
void free(void* virtual_address)
{
  ...
  801a1d:	eb 0d                	jmp    801a2c <free+0x6a>
		...
		for(int i=0;i<count;i++){
  801a1f:	ff 45 ec             	incl   -0x14(%ebp)
  801a22:	a1 28 30 80 00       	mov    0x803028,%eax
  801a27:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801a2a:	7c ab                	jl     8019d7 <free+0x15>
				break;
			}
		}
  ...
  801a2f:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  801a36:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801a39:	8b 04 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%eax
  801a40:	29 c2                	sub    %eax,%edx
  801a42:	89 d0                	mov    %edx,%eax
  801a44:	83 ec 08             	sub    $0x8,%esp
  801a47:	50                   	push   %eax
  801a48:	ff 75 f4             	pushl  -0xc(%ebp)
  801a4b:	e8 d9 02 00 00       	call   801d29 <sys_freeMem>
  ...
  801a56:	89 45 e8             	mov    %eax,-0x18(%ebp)
  801a59:	eb 2d                	jmp    801a88 <free+0xc6>
			arr_add[i].start=arr_add[i+1].start;
  801a5b:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801a5e:	40                   	inc    %eax
  801a5f:	8b 14 c5 e0 05 82 00 	mov    0x8205e0(,%eax,8),%edx
  801a66:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801a69:	89 14 c5 e0 05 82 00 	mov    %edx,0x8205e0(,%eax,8)
			arr_add[i].end=arr_add[i+1].end;
  801a70:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801a73:	40                   	inc    %eax
  801a74:	8b 14 c5 e4 05 82 00 	mov    0x8205e4(,%eax,8),%edx
  801a7b:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801a7e:	89 14 c5 e4 05 82 00 	mov    %edx,0x8205e4(,%eax,8)
  ...
  801a91:	7f c8                	jg     801a5b <free+0x99>
			arr_add[i].start=arr_add[i+1].start;
			arr_add[i].end=arr_add[i+1].end;
		}
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801ab0:	68 a8 2a 80 00       	push   $0x802aa8
  801ab5:	68 18 01 00 00       	push   $0x118
  801aba:	68 cb 2a 80 00       	push   $0x802acb
  801abf:	e8 24 ea ff ff       	call   8004e8 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801acd:	68 a8 2a 80 00       	push   $0x802aa8
  801ad2:	68 1e 01 00 00       	push   $0x11e
  801ad7:	68 cb 2a 80 00       	push   $0x802acb
  801adc:	e8 07 ea ff ff       	call   8004e8 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801aea:	68 a8 2a 80 00       	push   $0x802aa8
  801aef:	68 24 01 00 00       	push   $0x124
  801af4:	68 cb 2a 80 00       	push   $0x802acb
  801af9:	e8 ea e9 ff ff       	call   8004e8 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801b07:	68 a8 2a 80 00       	push   $0x802aa8
  801b0c:	68 29 01 00 00       	push   $0x129
  801b11:	68 cb 2a 80 00       	push   $0x802acb
  801b16:	e8 cd e9 ff ff       	call   8004e8 <_panic>
...
void expand(uint32 newSize)
{
  ...
  801b24:	68 a8 2a 80 00       	push   $0x802aa8
  801b29:	68 2f 01 00 00       	push   $0x12f
  801b2e:	68 cb 2a 80 00       	push   $0x802acb
  801b33:	e8 b0 e9 ff ff       	call   8004e8 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801b41:	68 a8 2a 80 00       	push   $0x802aa8
  801b46:	68 33 01 00 00       	push   $0x133
  801b4b:	68 cb 2a 80 00       	push   $0x802acb
  801b50:	e8 93 e9 ff ff       	call   8004e8 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801b5e:	68 a8 2a 80 00       	push   $0x802aa8
  801b63:	68 38 01 00 00       	push   $0x138
  801b68:	68 cb 2a 80 00       	push   $0x802acb
  801b6d:	e8 76 e9 ff ff       	call   8004e8 <_panic>

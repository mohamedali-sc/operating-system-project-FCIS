...
void _main(void)
{
  ...
  80004a:	e8 44 18 00 00       	call   801893 <smalloc>
  ...
  80005e:	e8 6d 1a 00 00       	call   801ad0 <sys_calculate_free_frames>
  800063:	89 45 f0             	mov    %eax,-0x10(%ebp)
	int usedDiskPages_before = sys_pf_calculate_allocated_pages() ;
  800066:	e8 e8 1a 00 00       	call   801b53 <sys_pf_calculate_allocated_pages>
  ...
  800099:	e8 87 1c 00 00       	call   801d25 <sys_create_env>
  ...
  8000b7:	68 2c 23 80 00       	push   $0x80232c
  8000bc:	e8 64 1c 00 00       	call   801d25 <sys_create_env>
  ...
  8000cd:	e8 71 1c 00 00       	call   801d43 <sys_run_env>
  8000d2:	83 c4 10             	add    $0x10,%esp
	env_sleep(5000) ;
  8000d5:	83 ec 0c             	sub    $0xc,%esp
  8000d8:	68 88 13 00 00       	push   $0x1388
  8000dd:	e8 df 1e 00 00       	call   801fc1 <env_sleep>
  8000e2:	83 c4 10             	add    $0x10,%esp
	sys_run_env(envIdProcessB);
  8000e5:	83 ec 0c             	sub    $0xc,%esp
  8000e8:	ff 75 e4             	pushl  -0x1c(%ebp)
  8000eb:	e8 53 1c 00 00       	call   801d43 <sys_run_env>
  ...
  8000fe:	e8 cd 19 00 00       	call   801ad0 <sys_calculate_free_frames>
  800103:	83 ec 08             	sub    $0x8,%esp
  800106:	50                   	push   %eax
  800107:	68 38 23 80 00       	push   $0x802338
  ...
  80011a:	e8 40 1c 00 00       	call   801d5f <sys_free_env>
  80011f:	83 c4 10             	add    $0x10,%esp
	sys_free_env(envIdProcessB);
  800122:	83 ec 0c             	sub    $0xc,%esp
  800125:	ff 75 e4             	pushl  -0x1c(%ebp)
  800128:	e8 32 1c 00 00       	call   801d5f <sys_free_env>
  80012d:	83 c4 10             	add    $0x10,%esp

	//Checking the number of frames after killing the created environments
	int freeFrames_after = sys_calculate_free_frames() ;
  800130:	e8 9b 19 00 00       	call   801ad0 <sys_calculate_free_frames>
  800135:	89 45 e0             	mov    %eax,-0x20(%ebp)
	int usedDiskPages_after = sys_pf_calculate_allocated_pages() ;
  800138:	e8 16 1a 00 00       	call   801b53 <sys_pf_calculate_allocated_pages>
  ...
  80014e:	68 6c 23 80 00       	push   $0x80236c
  800153:	e8 24 04 00 00       	call   80057c <cprintf>
  800158:	83 c4 10             	add    $0x10,%esp
				freeFrames_after);
		panic("env_free() does not work correctly... check it again.");
  80015b:	83 ec 04             	sub    $0x4,%esp
  80015e:	68 bc 23 80 00       	push   $0x8023bc
  800163:	6a 23                	push   $0x23
  800165:	68 f2 23 80 00       	push   $0x8023f2
...
libmain(int argc, char **argv)
{
  ...
  80019b:	e8 65 18 00 00       	call   801a05 <sys_getenvindex>
  ...
  800218:	e8 83 19 00 00       	call   801ba0 <sys_disable_interrupt>
	cprintf("**************************************\n");
  80021d:	83 ec 0c             	sub    $0xc,%esp
  800220:	68 cc 24 80 00       	push   $0x8024cc
  ...
  800246:	52                   	push   %edx
  800247:	50                   	push   %eax
  800248:	68 f4 24 80 00       	push   $0x8024f4
  ...
  80026e:	52                   	push   %edx
  80026f:	50                   	push   %eax
  800270:	68 1c 25 80 00       	push   $0x80251c
  ...
  80028b:	50                   	push   %eax
  80028c:	68 5d 25 80 00       	push   $0x80255d
  800291:	e8 e6 02 00 00       	call   80057c <cprintf>
  800296:	83 c4 10             	add    $0x10,%esp
	cprintf("**************************************\n");
  800299:	83 ec 0c             	sub    $0xc,%esp
  80029c:	68 cc 24 80 00       	push   $0x8024cc
  8002a1:	e8 d6 02 00 00       	call   80057c <cprintf>
  8002a6:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8002a9:	e8 0c 19 00 00       	call   801bba <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8002c1:	e8 0b 17 00 00       	call   8019d1 <sys_env_destroy>
...
exit(void)
{
  ...
  8002cf:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8002d2:	e8 60 17 00 00       	call   801a37 <sys_env_exit>
}
  8002d7:	90                   	nop
  8002d8:	c9                   	leave  
  8002d9:	c3                   	ret    
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8002fa:	50                   	push   %eax
  8002fb:	68 74 25 80 00       	push   $0x802574
  ...
  800313:	50                   	push   %eax
  800314:	68 79 25 80 00       	push   $0x802579
  ...
  800338:	68 95 25 80 00       	push   $0x802595
...
void CheckWSWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  800364:	68 98 25 80 00       	push   $0x802598
  800369:	6a 26                	push   $0x26
  80036b:	68 e4 25 80 00       	push   $0x8025e4
  ...
  80042a:	68 f0 25 80 00       	push   $0x8025f0
  80042f:	6a 3a                	push   $0x3a
  800431:	68 e4 25 80 00       	push   $0x8025e4
  ...
  800494:	68 44 26 80 00       	push   $0x802644
  800499:	6a 44                	push   $0x44
  80049b:	68 e4 25 80 00       	push   $0x8025e4
...
static void putch(int ch, struct printbuf *b) {
  ...
  8004ec:	51                   	push   %ecx
  8004ed:	52                   	push   %edx
  8004ee:	e8 9c 14 00 00       	call   80198f <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800564:	50                   	push   %eax
  800565:	e8 25 14 00 00       	call   80198f <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8005ac:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8005af:	e8 ec 15 00 00       	call   801ba0 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  8005cc:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  8005cf:	e8 e6 15 00 00       	call   801bba <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800619:	e8 5a 1a 00 00       	call   802078 <__udivdi3>
  ...
  800667:	52                   	push   %edx
  800668:	50                   	push   %eax
  800669:	e8 1a 1b 00 00       	call   802188 <__umoddi3>
  80066e:	83 c4 10             	add    $0x10,%esp
  800671:	05 b4 28 80 00       	add    $0x8028b4,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8007c4:	8b 04 85 d8 28 80 00 	mov    0x8028d8(,%eax,4),%eax
  ...
  8008a5:	8b 34 9d 20 27 80 00 	mov    0x802720(,%ebx,4),%esi
  8008ac:	85 f6                	test   %esi,%esi
  8008ae:	75 19                	jne    8008c9 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8008b0:	53                   	push   %ebx
  8008b1:	68 c5 28 80 00       	push   $0x8028c5
  ...
  8008c4:	e9 49 02 00 00       	jmp    800b12 <vprintfmt+0x3bc>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  8008c9:	56                   	push   %esi
  8008ca:	68 ce 28 80 00       	push   $0x8028ce
  ...
  8008f5:	75 05                	jne    8008fc <vprintfmt+0x1a6>
				p = "(null)";
  8008f7:	be d1 28 80 00       	mov    $0x8028d1,%esi
			if (width > 0 && padc != '-')
...
//	while(size%PAGE_SIZE!=0){
  ...
  801361:	68 30 2a 80 00       	push   $0x802a30
  ...
  80137f:	68 45 2a 80 00       	push   $0x802a45
  ...
  8013cc:	77 21                	ja     8013ef <malloc+0xe9>
  ...
  8013dd:	76 10                	jbe    8013ef <malloc+0xe9>
					ni=PAGE_SIZE;
  8013df:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%ebp)
					flag1=1;
  8013e6:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
					break;
  8013ed:	eb 0d                	jmp    8013fc <malloc+0xf6>
	}
  ...
  8013fa:	7c c1                	jl     8013bd <malloc+0xb7>
					ni=PAGE_SIZE;
					flag1=1;
					break;
				}
  ...
  801400:	74 09                	je     80140b <malloc+0x105>
				flag0=0;
  801402:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
				break;
  801409:	eb 16                	jmp    801421 <malloc+0x11b>
		cprintf("arr %d end is: %x\n",i,arr_add[i].end);
	}
  ...
  80141f:	77 93                	ja     8013b4 <malloc+0xae>
			if(flag1){
				flag0=0;
				break;
			}
  ...
  801425:	0f 84 a2 00 00 00    	je     8014cd <malloc+0x1c7>
  ...
  801485:	eb 36                	jmp    8014bd <malloc+0x1b7>
  ...
  80149b:	73 1d                	jae    8014ba <malloc+0x1b4>
					ni=arr_add[l].end-i;
  ...
  8014b1:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					break;
  8014b8:	eb 0d                	jmp    8014c7 <malloc+0x1c1>
			arr[count2].start=i;
			arr[count2].end = i+size;
			arr[count2].space=0;
			count2++;
  ...
  8014c5:	7c c0                	jl     801487 <malloc+0x181>
					break;
  ...
  8014cb:	75 1d                	jne    8014ea <malloc+0x1e4>
				break;
			}
  ...
  8014e2:	0f 8c bd fe ff ff    	jl     8013a5 <malloc+0x9f>
  8014e8:	eb 01                	jmp    8014eb <malloc+0x1e5>
  ...
  8014ef:	75 7a                	jne    80156b <malloc+0x265>
  ...
  801502:	7c 0a                	jl     80150e <malloc+0x208>
			return NULL;
  801504:	b8 00 00 00 00       	mov    $0x0,%eax
  801509:	e9 a4 02 00 00       	jmp    8017b2 <malloc+0x4ac>
		else{
			uint32 s=base_add;
  ...
  801566:	e9 47 02 00 00       	jmp    8017b2 <malloc+0x4ac>
	}
	else{
  ...
  801572:	e9 ac 00 00 00       	jmp    801623 <malloc+0x31d>
  ...
  8015ae:	77 1a                	ja     8015ca <malloc+0x2c4>
  ...
  8015bf:	76 09                	jbe    8015ca <malloc+0x2c4>
								flag=1;
  8015c1:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
								break;}
  8015c8:	eb 36                	jmp    801600 <malloc+0x2fa>
			arr[i].space++;
  ...
  8015fe:	7c 9f                	jl     80159f <malloc+0x299>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
								flag=1;
								break;}
			arr[i].space++;
  ...
  801604:	75 19                	jne    80161f <malloc+0x319>
	else{
  ...
  801617:	0f 82 72 ff ff ff    	jb     80158f <malloc+0x289>
  80161d:	eb 01                	jmp    801620 <malloc+0x31a>
								flag=1;
								break;}
			arr[i].space++;
			}
  ...
  801629:	0f 8c 48 ff ff ff    	jl     801577 <malloc+0x271>
			if(flag)
				break;
		}
	}
  ...
  801644:	eb 37                	jmp    80167d <malloc+0x377>
  ...
  80165c:	7d 1c                	jge    80167a <malloc+0x374>
			//cprintf("arr %d size is: %x\n",i,min);
			min=arr[i].space;
  ...
  801683:	7c c1                	jl     801646 <malloc+0x340>
			//cprintf("arr %d size is: %x\n",i,min);
  ...
  8016f9:	eb 78                	jmp    801773 <malloc+0x46d>
  ...
  801715:	68 30 2a 80 00       	push   $0x802a30
  80171a:	e8 5d ee ff ff       	call   80057c <cprintf>
  ...
  80173c:	68 45 2a 80 00       	push   $0x802a45
  801741:	e8 36 ee ff ff       	call   80057c <cprintf>
  ...
  801763:	68 58 2a 80 00       	push   $0x802a58
  801768:	e8 0f ee ff ff       	call   80057c <cprintf>
  ...
  801779:	7c 80                	jl     8016fb <malloc+0x3f5>
			cprintf("arr %d start is: %x\n",i,arr[i].start);
			cprintf("arr %d end is: %x\n",i,arr[i].end);
			cprintf("arr %d size is: %d\n",i,arr[i].space);
			}
  ...
  801791:	50                   	push   %eax
  801792:	68 6c 2a 80 00       	push   $0x802a6c
  801797:	e8 e0 ed ff ff       	call   80057c <cprintf>
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8018a2:	68 88 2a 80 00       	push   $0x802a88
  8018a7:	68 18 01 00 00       	push   $0x118
  8018ac:	68 ab 2a 80 00       	push   $0x802aab
  8018b1:	e8 24 ea ff ff       	call   8002da <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8018bf:	68 88 2a 80 00       	push   $0x802a88
  8018c4:	68 1e 01 00 00       	push   $0x11e
  8018c9:	68 ab 2a 80 00       	push   $0x802aab
  8018ce:	e8 07 ea ff ff       	call   8002da <_panic>
...
void sfree(void* virtual_address)
{
  ...
  8018dc:	68 88 2a 80 00       	push   $0x802a88
  8018e1:	68 24 01 00 00       	push   $0x124
  8018e6:	68 ab 2a 80 00       	push   $0x802aab
  8018eb:	e8 ea e9 ff ff       	call   8002da <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  8018f9:	68 88 2a 80 00       	push   $0x802a88
  8018fe:	68 29 01 00 00       	push   $0x129
  801903:	68 ab 2a 80 00       	push   $0x802aab
  801908:	e8 cd e9 ff ff       	call   8002da <_panic>
...
void expand(uint32 newSize)
{
  ...
  801916:	68 88 2a 80 00       	push   $0x802a88
  80191b:	68 2f 01 00 00       	push   $0x12f
  801920:	68 ab 2a 80 00       	push   $0x802aab
  801925:	e8 b0 e9 ff ff       	call   8002da <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801933:	68 88 2a 80 00       	push   $0x802a88
  801938:	68 33 01 00 00       	push   $0x133
  80193d:	68 ab 2a 80 00       	push   $0x802aab
  801942:	e8 93 e9 ff ff       	call   8002da <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801950:	68 88 2a 80 00       	push   $0x802a88
  801955:	68 38 01 00 00       	push   $0x138
  80195a:	68 ab 2a 80 00       	push   $0x802aab
  80195f:	e8 76 e9 ff ff       	call   8002da <_panic>
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  801fd1:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  801fd8:	01 d0                	add    %edx,%eax
  801fda:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
  ...
  801ff9:	8d 45 e8             	lea    -0x18(%ebp),%eax
  801ffc:	83 ec 0c             	sub    $0xc,%esp
  801fff:	50                   	push   %eax
  802000:	e8 76 fd ff ff       	call   801d7b <sys_get_virtual_time>
  802005:	83 c4 0c             	add    $0xc,%esp
	while(cycles_counter<time_in_cycles)
  802008:	eb 41                	jmp    80204b <env_sleep+0x8a>
	{
		struct uint64 currentTime = sys_get_virtual_time() ;
  80200a:	8d 45 e0             	lea    -0x20(%ebp),%eax
  80200d:	83 ec 0c             	sub    $0xc,%esp
  802010:	50                   	push   %eax
  802011:	e8 65 fd ff ff       	call   801d7b <sys_get_virtual_time>
  ...
  80201c:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80201f:	29 c2                	sub    %eax,%edx
  802021:	89 d0                	mov    %edx,%eax
  802023:	89 45 d8             	mov    %eax,-0x28(%ebp)
		res.hi = (currentTime.hi - baseTime.hi - (res.low > currentTime.low)) & M32;
  802026:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  802029:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80202c:	89 d1                	mov    %edx,%ecx
  80202e:	29 c1                	sub    %eax,%ecx
  802030:	8b 55 d8             	mov    -0x28(%ebp),%edx
  802033:	8b 45 e0             	mov    -0x20(%ebp),%eax
  802036:	39 c2                	cmp    %eax,%edx
  802038:	0f 97 c0             	seta   %al
  80203b:	0f b6 c0             	movzbl %al,%eax
  80203e:	29 c1                	sub    %eax,%ecx
  802040:	89 c8                	mov    %ecx,%eax
  802042:	89 45 dc             	mov    %eax,-0x24(%ebp)

		//update cycles_count with result
		cycles_counter = res.low;
  802045:	8b 45 d8             	mov    -0x28(%ebp),%eax
...
//	cprintf("%s go to sleep...\n", myEnv->prog_name);
  ...
  80204e:	3b 45 f0             	cmp    -0x10(%ebp),%eax
  802051:	72 b7                	jb     80200a <env_sleep+0x49>
//				,cycles_counter
//				);
	}
...
uint32 busy_wait(uint32 loopMax)
{
  ...
  802059:	83 ec 10             	sub    $0x10,%esp
	uint32 i = 0 ;
  80205c:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
	while (i < loopMax) i++;
  802063:	eb 03                	jmp    802068 <busy_wait+0x12>
  802065:	ff 45 fc             	incl   -0x4(%ebp)
  802068:	8b 45 fc             	mov    -0x4(%ebp),%eax
  80206b:	3b 45 08             	cmp    0x8(%ebp),%eax
  80206e:	72 f5                	jb     802065 <busy_wait+0xf>
	return i;

...
void _main(void)
{
  ...
  800041:	e8 66 23 00 00       	call   8023ac <sys_disable_interrupt>
  ...
  800162:	e8 5f 22 00 00       	call   8023c6 <sys_enable_interrupt>
  ...
  8001d4:	83 c4 10             	add    $0x10,%esp
		...
		sys_disable_interrupt();
  8001d7:	e8 d0 21 00 00       	call   8023ac <sys_disable_interrupt>
  ...
  8001e9:	83 c4 10             	add    $0x10,%esp
		...
		sys_enable_interrupt();
  8001ec:	e8 d5 21 00 00       	call   8023c6 <sys_enable_interrupt>
  ...
  80021a:	e8 c1 06 00 00       	call   8008e0 <_panic>
		...
		{
			sys_disable_interrupt();
  80021f:	e8 88 21 00 00       	call   8023ac <sys_disable_interrupt>
			cprintf("===============================================\n") ;
  ...
  800251:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  800254:	e8 6d 21 00 00       	call   8023c6 <sys_enable_interrupt>
		}

		//free(Elements) ;

		sys_disable_interrupt();
  800259:	e8 4e 21 00 00       	call   8023ac <sys_disable_interrupt>
			Chose = 0 ;
  ...
  8002b0:	75 b2                	jne    800264 <_main+0x22c>
		...
		sys_enable_interrupt();
  8002b2:	e8 0f 21 00 00       	call   8023c6 <sys_enable_interrupt>
...
cputchar(int ch)
{
  ...
  80070e:	50                   	push   %eax
  80070f:	e8 cc 1c 00 00       	call   8023e0 <sys_cputc>
...
atomic_cputchar(int ch)
{
  ...
  80071d:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800720:	e8 87 1c 00 00       	call   8023ac <sys_disable_interrupt>
	char c = ch;
  ...
  800732:	50                   	push   %eax
  800733:	e8 a8 1c 00 00       	call   8023e0 <sys_cputc>
  800738:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  80073b:	e8 86 1c 00 00       	call   8023c6 <sys_enable_interrupt>
}
  800740:	90                   	nop
  800741:	c9                   	leave  
  800742:	c3                   	ret    
...
getchar(void)
{
  ...
  800750:	eb 08                	jmp    80075a <getchar+0x17>
	{
		c = sys_cgetc();
  800752:	e8 6d 1a 00 00       	call   8021c4 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800768:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  80076b:	e8 3c 1c 00 00       	call   8023ac <sys_disable_interrupt>
	int c=0;
  ...
  800777:	eb 08                	jmp    800781 <atomic_getchar+0x1c>
	{
		c = sys_cgetc();
  800779:	e8 46 1a 00 00       	call   8021c4 <sys_cgetc>
...
atomic_getchar(void)
{
  ...
  800785:	74 f2                	je     800779 <atomic_getchar+0x14>
	...
	sys_enable_interrupt();
  800787:	e8 3a 1c 00 00       	call   8023c6 <sys_enable_interrupt>
	return c;
...
libmain(int argc, char **argv)
{
  ...
  8007a1:	e8 6b 1a 00 00       	call   802211 <sys_getenvindex>
  ...
  80081b:	83 c4 10             	add    $0x10,%esp
	...
	sys_disable_interrupt();
  80081e:	e8 89 1b 00 00       	call   8023ac <sys_disable_interrupt>
	cprintf("**************************************\n");
  ...
  8008ac:	83 c4 10             	add    $0x10,%esp
	sys_enable_interrupt();
  8008af:	e8 12 1b 00 00       	call   8023c6 <sys_enable_interrupt>
...
destroy(void)
{
  ...
  8008c7:	e8 11 19 00 00       	call   8021dd <sys_env_destroy>
...
exit(void)
{
  ...
  8008d5:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  8008d8:	e8 66 19 00 00       	call   802243 <sys_env_exit>
}
  8008dd:	90                   	nop
  8008de:	c9                   	leave  
  8008df:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  800af2:	51                   	push   %ecx
  800af3:	52                   	push   %edx
  800af4:	e8 a2 16 00 00       	call   80219b <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  800b6a:	50                   	push   %eax
  800b6b:	e8 2b 16 00 00       	call   80219b <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  800bb2:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  800bb5:	e8 f2 17 00 00       	call   8023ac <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800bd2:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800bd5:	e8 ec 17 00 00       	call   8023c6 <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800c1f:	e8 ac 1b 00 00       	call   8027d0 <__udivdi3>
  ...
  800c6d:	52                   	push   %edx
  800c6e:	50                   	push   %eax
  800c6f:	e8 6c 1c 00 00       	call   8028e0 <__umoddi3>
...
void atomic_readline(const char *prompt, char* buf)
{
  ...
  801305:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  801308:	e8 9f 10 00 00       	call   8023ac <sys_disable_interrupt>
	int i, c, echoing;
  ...
  801361:	83 c4 10             	add    $0x10,%esp
			sys_enable_interrupt();
  801364:	e8 5d 10 00 00       	call   8023c6 <sys_enable_interrupt>
			return;
  ...
  8013f9:	c6 00 00             	movb   $0x0,(%eax)
			sys_enable_interrupt();
  8013fc:	e8 c5 0f 00 00       	call   8023c6 <sys_enable_interrupt>
			return;
...
//	while(size%PAGE_SIZE!=0){
  ...
  801bd8:	77 21                	ja     801bfb <malloc+0xe9>
  ...
  801be9:	76 10                	jbe    801bfb <malloc+0xe9>
					ni=PAGE_SIZE;
  801beb:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%ebp)
					flag1=1;
  801bf2:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
					break;
  801bf9:	eb 0d                	jmp    801c08 <malloc+0xf6>
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		...
		for(int j=i;j<i+size;j+=PAGE_SIZE){
			for(int k=0;k<count;k++){
  801bfb:	ff 45 d8             	incl   -0x28(%ebp)
  801bfe:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801c03:	39 45 d8             	cmp    %eax,-0x28(%ebp)
  801c06:	7c c1                	jl     801bc9 <malloc+0xb7>
					ni=PAGE_SIZE;
					flag1=1;
					break;
				}
  ...
  801c0c:	74 09                	je     801c17 <malloc+0x105>
				flag0=0;
  801c0e:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
				break;
  801c15:	eb 16                	jmp    801c2d <malloc+0x11b>
		cprintf("arr %d end is: %x\n",i,arr_add[i].end);
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		int flag0=1;
		for(int j=i;j<i+size;j+=PAGE_SIZE){
  801c17:	81 45 dc 00 10 00 00 	addl   $0x1000,-0x24(%ebp)
  801c1e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801c21:	8b 45 08             	mov    0x8(%ebp),%eax
  801c24:	01 c2                	add    %eax,%edx
  801c26:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801c29:	39 c2                	cmp    %eax,%edx
  801c2b:	77 93                	ja     801bc0 <malloc+0xae>
			if(flag1){
				flag0=0;
				break;
			}
		...
		if(flag0){
  801c2d:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  801c31:	0f 84 a2 00 00 00    	je     801cd9 <malloc+0x1c7>

			int f=1;
  801c37:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)

			arr[count2].start=i;
  801c3e:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801c41:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  801c44:	89 c8                	mov    %ecx,%eax
  801c46:	01 c0                	add    %eax,%eax
  801c48:	01 c8                	add    %ecx,%eax
  801c4a:	c1 e0 02             	shl    $0x2,%eax
  801c4d:	05 20 41 80 00       	add    $0x804120,%eax
  801c52:	89 10                	mov    %edx,(%eax)
			arr[count2].end = i+size;
  801c54:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801c57:	8b 45 08             	mov    0x8(%ebp),%eax
  801c5a:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
  ...
  801c69:	05 24 41 80 00       	add    $0x804124,%eax
  ...
  801c7c:	05 28 41 80 00       	add    $0x804128,%eax
  801c81:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			count2++;
  801c87:	ff 45 f4             	incl   -0xc(%ebp)

			for(int l=0;l<count;l++){
  801c8a:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
  801c91:	eb 36                	jmp    801cc9 <malloc+0x1b7>
				if(i+size<arr_add[l].start){
  801c93:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801c96:	8b 45 08             	mov    0x8(%ebp),%eax
  801c99:	01 c2                	add    %eax,%edx
  801c9b:	8b 45 d0             	mov    -0x30(%ebp),%eax
  801c9e:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  801ca5:	39 c2                	cmp    %eax,%edx
  801ca7:	73 1d                	jae    801cc6 <malloc+0x1b4>
					ni=arr_add[l].end-i;
  801ca9:	8b 45 d0             	mov    -0x30(%ebp),%eax
  801cac:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801cb3:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801cb6:	29 c2                	sub    %eax,%edx
  801cb8:	89 d0                	mov    %edx,%eax
  801cba:	89 45 ec             	mov    %eax,-0x14(%ebp)
					f=0;
  801cbd:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					break;
  801cc4:	eb 0d                	jmp    801cd3 <malloc+0x1c1>
			arr[count2].start=i;
			arr[count2].end = i+size;
			arr[count2].space=0;
			count2++;
  ...
  801cd7:	75 1d                	jne    801cf6 <malloc+0x1e4>
				break;
			}
		...
		flag1=0;
  801cd9:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  ...
  801ce3:	01 45 e4             	add    %eax,-0x1c(%ebp)
  801ce6:	a1 04 40 80 00       	mov    0x804004,%eax
  801ceb:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801cee:	0f 8c bd fe ff ff    	jl     801bb1 <malloc+0x9f>
  801cf4:	eb 01                	jmp    801cf7 <malloc+0x1e5>
  ...
  801cfb:	75 7a                	jne    801d77 <malloc+0x265>
		//cprintf("hellllllllOOlooo");
		if((int)(base_add+size-1)>=(int)USER_HEAP_MAX)
  801cfd:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801d03:	8b 45 08             	mov    0x8(%ebp),%eax
  801d06:	01 d0                	add    %edx,%eax
  801d08:	48                   	dec    %eax
  801d09:	3d 00 00 00 a0       	cmp    $0xa0000000,%eax
  801d0e:	7c 0a                	jl     801d1a <malloc+0x208>
			return NULL;
  801d10:	b8 00 00 00 00       	mov    $0x0,%eax
  801d15:	e9 a4 02 00 00       	jmp    801fbe <malloc+0x4ac>
		else{
			uint32 s=base_add;
  801d1a:	a1 04 40 80 00       	mov    0x804004,%eax
  801d1f:	89 45 a4             	mov    %eax,-0x5c(%ebp)
			//cprintf("s: %x",s);
			arr_add[count].start=s;
  801d22:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801d27:	8b 55 a4             	mov    -0x5c(%ebp),%edx
  801d2a:	89 14 c5 e0 15 82 00 	mov    %edx,0x8215e0(,%eax,8)
		    sys_allocateMem(s,size);
  801d31:	83 ec 08             	sub    $0x8,%esp
  801d34:	ff 75 08             	pushl  0x8(%ebp)
  801d37:	ff 75 a4             	pushl  -0x5c(%ebp)
  801d3a:	e8 04 06 00 00       	call   802343 <sys_allocateMem>
  ...
  801d4d:	a3 04 40 80 00       	mov    %eax,0x804004
			arr_add[count].end=base_add;
  801d52:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801d57:	8b 15 04 40 80 00    	mov    0x804004,%edx
  801d5d:	89 14 c5 e4 15 82 00 	mov    %edx,0x8215e4(,%eax,8)
			count++;
  ...
  801d6a:	a3 2c 40 80 00       	mov    %eax,0x80402c
			...
			return (void*)s;
  801d6f:	8b 45 a4             	mov    -0x5c(%ebp),%eax
  801d72:	e9 47 02 00 00       	jmp    801fbe <malloc+0x4ac>
	}
	else{
  ...
  801d77:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%ebp)
  801d7e:	e9 ac 00 00 00       	jmp    801e2f <malloc+0x31d>
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801d83:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801d86:	89 d0                	mov    %edx,%eax
  801d88:	01 c0                	add    %eax,%eax
  801d8a:	01 d0                	add    %edx,%eax
  801d8c:	c1 e0 02             	shl    $0x2,%eax
  801d8f:	05 24 41 80 00       	add    $0x804124,%eax
  801d94:	8b 00                	mov    (%eax),%eax
  801d96:	89 45 c8             	mov    %eax,-0x38(%ebp)
  801d99:	eb 7e                	jmp    801e19 <malloc+0x307>
			int flag=0;
  801d9b:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
			for(int k=0;k<count;k++){
  801da2:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
  801da9:	eb 57                	jmp    801e02 <malloc+0x2f0>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
  801dab:	8b 45 c0             	mov    -0x40(%ebp),%eax
  801dae:	8b 14 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%edx
  801db5:	8b 45 c8             	mov    -0x38(%ebp),%eax
  801db8:	39 c2                	cmp    %eax,%edx
  801dba:	77 1a                	ja     801dd6 <malloc+0x2c4>
  801dbc:	8b 45 c0             	mov    -0x40(%ebp),%eax
  801dbf:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  801dc6:	8b 45 c8             	mov    -0x38(%ebp),%eax
  801dc9:	39 c2                	cmp    %eax,%edx
  801dcb:	76 09                	jbe    801dd6 <malloc+0x2c4>
								flag=1;
  801dcd:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
								break;}
  801dd4:	eb 36                	jmp    801e0c <malloc+0x2fa>
			arr[i].space++;
  801dd6:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801dd9:	89 d0                	mov    %edx,%eax
  801ddb:	01 c0                	add    %eax,%eax
  801ddd:	01 d0                	add    %edx,%eax
  801ddf:	c1 e0 02             	shl    $0x2,%eax
  801de2:	05 28 41 80 00       	add    $0x804128,%eax
  801de7:	8b 00                	mov    (%eax),%eax
  801de9:	8d 48 01             	lea    0x1(%eax),%ecx
  801dec:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801def:	89 d0                	mov    %edx,%eax
  801df1:	01 c0                	add    %eax,%eax
  801df3:	01 d0                	add    %edx,%eax
  801df5:	c1 e0 02             	shl    $0x2,%eax
  801df8:	05 28 41 80 00       	add    $0x804128,%eax
  801dfd:	89 08                	mov    %ecx,(%eax)
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
			int flag=0;
			for(int k=0;k<count;k++){
  801dff:	ff 45 c0             	incl   -0x40(%ebp)
  801e02:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801e07:	39 45 c0             	cmp    %eax,-0x40(%ebp)
  801e0a:	7c 9f                	jl     801dab <malloc+0x299>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
								flag=1;
								break;}
			arr[i].space++;
			...
			if(flag)
  801e0c:	83 7d c4 00          	cmpl   $0x0,-0x3c(%ebp)
  801e10:	75 19                	jne    801e2b <malloc+0x319>
	else{
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801e12:	81 45 c8 00 10 00 00 	addl   $0x1000,-0x38(%ebp)
  801e19:	8b 55 c8             	mov    -0x38(%ebp),%edx
  801e1c:	a1 04 40 80 00       	mov    0x804004,%eax
  801e21:	39 c2                	cmp    %eax,%edx
  801e23:	0f 82 72 ff ff ff    	jb     801d9b <malloc+0x289>
  801e29:	eb 01                	jmp    801e2c <malloc+0x31a>
								flag=1;
								break;}
			arr[i].space++;
			}
  ...
  801e2b:	90                   	nop
	...
	for(int i=0;i<count2;i++){
  801e2c:	ff 45 cc             	incl   -0x34(%ebp)
  801e2f:	8b 45 cc             	mov    -0x34(%ebp),%eax
  801e32:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801e35:	0f 8c 48 ff ff ff    	jl     801d83 <malloc+0x271>
			if(flag)
				break;
		}
	}
	...
	int index=0;
  801e3b:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
	int min=9999999;
  801e42:	c7 45 b8 7f 96 98 00 	movl   $0x98967f,-0x48(%ebp)
	for(int i=0;i<count2;i++){
  801e49:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
  801e50:	eb 37                	jmp    801e89 <malloc+0x377>
		//cprintf("arr %d size is: %x\n",i,arr[i].space);
		if(arr[i].space<min){
  801e52:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  801e55:	89 d0                	mov    %edx,%eax
  801e57:	01 c0                	add    %eax,%eax
  801e59:	01 d0                	add    %edx,%eax
  801e5b:	c1 e0 02             	shl    $0x2,%eax
  801e5e:	05 28 41 80 00       	add    $0x804128,%eax
  801e63:	8b 00                	mov    (%eax),%eax
  801e65:	3b 45 b8             	cmp    -0x48(%ebp),%eax
  801e68:	7d 1c                	jge    801e86 <malloc+0x374>
			//cprintf("arr %d size is: %x\n",i,min);
			min=arr[i].space;
  801e6a:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  801e6d:	89 d0                	mov    %edx,%eax
  801e6f:	01 c0                	add    %eax,%eax
  801e71:	01 d0                	add    %edx,%eax
  801e73:	c1 e0 02             	shl    $0x2,%eax
  801e76:	05 28 41 80 00       	add    $0x804128,%eax
  801e7b:	8b 00                	mov    (%eax),%eax
  801e7d:	89 45 b8             	mov    %eax,-0x48(%ebp)
			index=i;
  801e80:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801e83:	89 45 bc             	mov    %eax,-0x44(%ebp)
		}
	}
	...
	int min=9999999;
	for(int i=0;i<count2;i++){
  801e86:	ff 45 b4             	incl   -0x4c(%ebp)
  801e89:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801e8c:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801e8f:	7c c1                	jl     801e52 <malloc+0x340>
			//cprintf("arr %d size is: %x\n",i,min);
  ...
  801e91:	8b 15 2c 40 80 00    	mov    0x80402c,%edx
  801e97:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  801e9a:	89 c8                	mov    %ecx,%eax
  801e9c:	01 c0                	add    %eax,%eax
  801e9e:	01 c8                	add    %ecx,%eax
  801ea0:	c1 e0 02             	shl    $0x2,%eax
  801ea3:	05 20 41 80 00       	add    $0x804120,%eax
  801ea8:	8b 00                	mov    (%eax),%eax
  801eaa:	89 04 d5 e0 15 82 00 	mov    %eax,0x8215e0(,%edx,8)
	arr_add[count].end=arr[index].end;
  801eb1:	8b 15 2c 40 80 00    	mov    0x80402c,%edx
  801eb7:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  801eba:	89 c8                	mov    %ecx,%eax
  801ebc:	01 c0                	add    %eax,%eax
  801ebe:	01 c8                	add    %ecx,%eax
  801ec0:	c1 e0 02             	shl    $0x2,%eax
  801ec3:	05 24 41 80 00       	add    $0x804124,%eax
  801ec8:	8b 00                	mov    (%eax),%eax
  801eca:	89 04 d5 e4 15 82 00 	mov    %eax,0x8215e4(,%edx,8)
	count++;
  801ed1:	a1 2c 40 80 00       	mov    0x80402c,%eax
  801ed6:	40                   	inc    %eax
  801ed7:	a3 2c 40 80 00       	mov    %eax,0x80402c


		sys_allocateMem(arr[index].start,size);
  801edc:	8b 55 bc             	mov    -0x44(%ebp),%edx
  801edf:	89 d0                	mov    %edx,%eax
  801ee1:	01 c0                	add    %eax,%eax
  801ee3:	01 d0                	add    %edx,%eax
  801ee5:	c1 e0 02             	shl    $0x2,%eax
  801ee8:	05 20 41 80 00       	add    $0x804120,%eax
  801eed:	8b 00                	mov    (%eax),%eax
  801eef:	83 ec 08             	sub    $0x8,%esp
  801ef2:	ff 75 08             	pushl  0x8(%ebp)
  801ef5:	50                   	push   %eax
  801ef6:	e8 48 04 00 00       	call   802343 <sys_allocateMem>
  801efb:	83 c4 10             	add    $0x10,%esp

		for(int i=0;i<count2;i++){
  801efe:	c7 45 b0 00 00 00 00 	movl   $0x0,-0x50(%ebp)
  801f05:	eb 78                	jmp    801f7f <malloc+0x46d>

			cprintf("arr %d start is: %x\n",i,arr[i].start);
  801f07:	8b 55 b0             	mov    -0x50(%ebp),%edx
  801f0a:	89 d0                	mov    %edx,%eax
  801f0c:	01 c0                	add    %eax,%eax
  801f0e:	01 d0                	add    %edx,%eax
  801f10:	c1 e0 02             	shl    $0x2,%eax
  801f13:	05 20 41 80 00       	add    $0x804120,%eax
  801f18:	8b 00                	mov    (%eax),%eax
  801f1a:	83 ec 04             	sub    $0x4,%esp
  801f1d:	50                   	push   %eax
  801f1e:	ff 75 b0             	pushl  -0x50(%ebp)
  801f21:	68 a4 31 80 00       	push   $0x8031a4
  801f26:	e8 57 ec ff ff       	call   800b82 <cprintf>
  801f2b:	83 c4 10             	add    $0x10,%esp
			cprintf("arr %d end is: %x\n",i,arr[i].end);
  801f2e:	8b 55 b0             	mov    -0x50(%ebp),%edx
  801f31:	89 d0                	mov    %edx,%eax
  801f33:	01 c0                	add    %eax,%eax
  801f35:	01 d0                	add    %edx,%eax
  801f37:	c1 e0 02             	shl    $0x2,%eax
  801f3a:	05 24 41 80 00       	add    $0x804124,%eax
  801f3f:	8b 00                	mov    (%eax),%eax
  801f41:	83 ec 04             	sub    $0x4,%esp
  801f44:	50                   	push   %eax
  801f45:	ff 75 b0             	pushl  -0x50(%ebp)
  801f48:	68 b9 31 80 00       	push   $0x8031b9
  801f4d:	e8 30 ec ff ff       	call   800b82 <cprintf>
  801f52:	83 c4 10             	add    $0x10,%esp
			cprintf("arr %d size is: %d\n",i,arr[i].space);
  801f55:	8b 55 b0             	mov    -0x50(%ebp),%edx
  801f58:	89 d0                	mov    %edx,%eax
  801f5a:	01 c0                	add    %eax,%eax
  801f5c:	01 d0                	add    %edx,%eax
  801f5e:	c1 e0 02             	shl    $0x2,%eax
  801f61:	05 28 41 80 00       	add    $0x804128,%eax
  801f66:	8b 00                	mov    (%eax),%eax
  801f68:	83 ec 04             	sub    $0x4,%esp
  801f6b:	50                   	push   %eax
  801f6c:	ff 75 b0             	pushl  -0x50(%ebp)
  801f6f:	68 cc 31 80 00       	push   $0x8031cc
  801f74:	e8 09 ec ff ff       	call   800b82 <cprintf>
  801f79:	83 c4 10             	add    $0x10,%esp
	count++;
		...
		for(int i=0;i<count2;i++){
  801f7c:	ff 45 b0             	incl   -0x50(%ebp)
  801f7f:	8b 45 b0             	mov    -0x50(%ebp),%eax
  801f82:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801f85:	7c 80                	jl     801f07 <malloc+0x3f5>
			cprintf("arr %d start is: %x\n",i,arr[i].start);
			cprintf("arr %d end is: %x\n",i,arr[i].end);
			cprintf("arr %d size is: %d\n",i,arr[i].space);
			}
...
void free(void* virtual_address)
{
  ...
  801ff9:	7e 22                	jle    80201d <free+0x5d>
				start=arr_add[i].start;
  801ffb:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801ffe:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  802005:	89 45 f4             	mov    %eax,-0xc(%ebp)
				end=arr_add[i].end;
  802008:	8b 45 ec             	mov    -0x14(%ebp),%eax
  80200b:	8b 04 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%eax
  802012:	89 45 e0             	mov    %eax,-0x20(%ebp)
				index=i;
  802015:	8b 45 ec             	mov    -0x14(%ebp),%eax
  802018:	89 45 f0             	mov    %eax,-0x10(%ebp)
				break;
  80201b:	eb 0d                	jmp    80202a <free+0x6a>
		...
		for(int i=0;i<count;i++){
  80201d:	ff 45 ec             	incl   -0x14(%ebp)
  802020:	a1 2c 40 80 00       	mov    0x80402c,%eax
  802025:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  802028:	7c ab                	jl     801fd5 <free+0x15>
				break;
			}
		}
  ...
  80202d:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  802034:	8b 45 f0             	mov    -0x10(%ebp),%eax
  802037:	8b 04 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%eax
  80203e:	29 c2                	sub    %eax,%edx
  802040:	89 d0                	mov    %edx,%eax
  802042:	83 ec 08             	sub    $0x8,%esp
  802045:	50                   	push   %eax
  802046:	ff 75 f4             	pushl  -0xc(%ebp)
  802049:	e8 d9 02 00 00       	call   802327 <sys_freeMem>
  ...
  802057:	eb 2d                	jmp    802086 <free+0xc6>
			arr_add[i].start=arr_add[i+1].start;
  802059:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80205c:	40                   	inc    %eax
  80205d:	8b 14 c5 e0 15 82 00 	mov    0x8215e0(,%eax,8),%edx
  802064:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802067:	89 14 c5 e0 15 82 00 	mov    %edx,0x8215e0(,%eax,8)
			arr_add[i].end=arr_add[i+1].end;
  80206e:	8b 45 e8             	mov    -0x18(%ebp),%eax
  802071:	40                   	inc    %eax
  802072:	8b 14 c5 e4 15 82 00 	mov    0x8215e4(,%eax,8),%edx
  802079:	8b 45 e8             	mov    -0x18(%ebp),%eax
  80207c:	89 14 c5 e4 15 82 00 	mov    %edx,0x8215e4(,%eax,8)
		...
		for(int i=index;i<count-1;i++){
  802083:	ff 45 e8             	incl   -0x18(%ebp)
  802086:	a1 2c 40 80 00       	mov    0x80402c,%eax
  80208b:	48                   	dec    %eax
  80208c:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  80208f:	7f c8                	jg     802059 <free+0x99>
			arr_add[i].start=arr_add[i+1].start;
			arr_add[i].end=arr_add[i+1].end;
		}

		count--;
  802091:	a1 2c 40 80 00       	mov    0x80402c,%eax
  802096:	48                   	dec    %eax
  802097:	a3 2c 40 80 00       	mov    %eax,0x80402c
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  8020a8:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  8020ab:	83 ec 04             	sub    $0x4,%esp
  8020ae:	68 fc 31 80 00       	push   $0x8031fc
  8020b3:	68 18 01 00 00       	push   $0x118
  8020b8:	68 1f 32 80 00       	push   $0x80321f
  8020bd:	e8 1e e8 ff ff       	call   8008e0 <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  8020cb:	68 fc 31 80 00       	push   $0x8031fc
  8020d0:	68 1e 01 00 00       	push   $0x11e
  8020d5:	68 1f 32 80 00       	push   $0x80321f
  8020da:	e8 01 e8 ff ff       	call   8008e0 <_panic>
...
void sfree(void* virtual_address)
{
  ...
  8020e8:	68 fc 31 80 00       	push   $0x8031fc
  8020ed:	68 24 01 00 00       	push   $0x124
  8020f2:	68 1f 32 80 00       	push   $0x80321f
  8020f7:	e8 e4 e7 ff ff       	call   8008e0 <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  802105:	68 fc 31 80 00       	push   $0x8031fc
  80210a:	68 29 01 00 00       	push   $0x129
  80210f:	68 1f 32 80 00       	push   $0x80321f
  802114:	e8 c7 e7 ff ff       	call   8008e0 <_panic>
...
void expand(uint32 newSize)
{
  ...
  802122:	68 fc 31 80 00       	push   $0x8031fc
  802127:	68 2f 01 00 00       	push   $0x12f
  80212c:	68 1f 32 80 00       	push   $0x80321f
  802131:	e8 aa e7 ff ff       	call   8008e0 <_panic>
...
void shrink(uint32 newSize)
{
  ...
  80213f:	68 fc 31 80 00       	push   $0x8031fc
  802144:	68 33 01 00 00       	push   $0x133
  802149:	68 1f 32 80 00       	push   $0x80321f
  80214e:	e8 8d e7 ff ff       	call   8008e0 <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  80215c:	68 fc 31 80 00       	push   $0x8031fc
  802161:	68 38 01 00 00       	push   $0x138
  802166:	68 1f 32 80 00       	push   $0x80321f
  80216b:	e8 70 e7 ff ff       	call   8008e0 <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  802185:	8b 7d 18             	mov    0x18(%ebp),%edi
  802188:	8b 75 1c             	mov    0x1c(%ebp),%esi
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  8021b9:	e8 b2 ff ff ff       	call   802170 <syscall>
...
sys_cgetc(void)
{
  ...
  8021d3:	e8 98 ff ff ff       	call   802170 <syscall>
  8021d8:	83 c4 18             	add    $0x18,%esp
}
  8021db:	c9                   	leave  
  8021dc:	c3                   	ret    

008021dd <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  8021eb:	50                   	push   %eax
  8021ec:	6a 05                	push   $0x5
  8021ee:	e8 7d ff ff ff       	call   802170 <syscall>
  8021f3:	83 c4 18             	add    $0x18,%esp
}
  8021f6:	c9                   	leave  
  8021f7:	c3                   	ret    

008021f8 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  802207:	e8 64 ff ff ff       	call   802170 <syscall>
  80220c:	83 c4 18             	add    $0x18,%esp
}
  80220f:	c9                   	leave  
  802210:	c3                   	ret    

00802211 <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  80221e:	6a 03                	push   $0x3
  802220:	e8 4b ff ff ff       	call   802170 <syscall>
  802225:	83 c4 18             	add    $0x18,%esp
}
  802228:	c9                   	leave  
  802229:	c3                   	ret    

0080222a <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  802237:	6a 04                	push   $0x4
  802239:	e8 32 ff ff ff       	call   802170 <syscall>
  80223e:	83 c4 18             	add    $0x18,%esp
}
  802241:	c9                   	leave  
  802242:	c3                   	ret    

00802243 <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  802252:	e8 19 ff ff ff       	call   802170 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  802270:	e8 fb fe ff ff       	call   802170 <syscall>
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  802291:	52                   	push   %edx
  802292:	50                   	push   %eax
  802293:	6a 08                	push   $0x8
  802295:	e8 d6 fe ff ff       	call   802170 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  8022b3:	52                   	push   %edx
  8022b4:	50                   	push   %eax
  8022b5:	6a 09                	push   $0x9
  8022b7:	e8 b4 fe ff ff       	call   802170 <syscall>
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  8022d2:	e8 99 fe ff ff       	call   802170 <syscall>
...
uint32 sys_calculate_free_frames()
{
  ...
  8022e9:	6a 0b                	push   $0xb
  8022eb:	e8 80 fe ff ff       	call   802170 <syscall>
...
uint32 sys_calculate_modified_frames()
{
  ...
  802302:	6a 0c                	push   $0xc
  802304:	e8 67 fe ff ff       	call   802170 <syscall>
...
uint32 sys_calculate_notmod_frames()
{
  ...
  80231b:	6a 0d                	push   $0xd
  80231d:	e8 4e fe ff ff       	call   802170 <syscall>
  802322:	83 c4 18             	add    $0x18,%esp
}
  802325:	c9                   	leave  
  802326:	c3                   	ret    

00802327 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  802336:	6a 11                	push   $0x11
  802338:	e8 33 fe ff ff       	call   802170 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  802352:	6a 12                	push   $0x12
  802354:	e8 17 fe ff ff       	call   802170 <syscall>
...
0080235f <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  80236e:	e8 fd fd ff ff       	call   802170 <syscall>
  802373:	83 c4 18             	add    $0x18,%esp
}
  802376:	c9                   	leave  
  802377:	c3                   	ret    

00802378 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  802386:	6a 0f                	push   $0xf
  802388:	e8 e3 fd ff ff       	call   802170 <syscall>
  80238d:	83 c4 18             	add    $0x18,%esp
}
  802390:	c9                   	leave  
  802391:	c3                   	ret    

00802392 <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  8023a1:	e8 ca fd ff ff       	call   802170 <syscall>
...
008023ac <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  8023b9:	6a 14                	push   $0x14
  8023bb:	e8 b0 fd ff ff       	call   802170 <syscall>
...
sys_enable_interrupt()
{
  ...
  8023d5:	e8 96 fd ff ff       	call   802170 <syscall>
...
sys_cputc(const char c)
{
  ...
  8023e9:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_cputc, (uint32) c, 0, 0, 0, 0);
  8023ec:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  ...
  8023fb:	e8 70 fd ff ff       	call   802170 <syscall>
...
sys_clear_ffl()
{
  ...
  802413:	6a 17                	push   $0x17
  802415:	e8 56 fd ff ff       	call   802170 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  80242f:	50                   	push   %eax
  802430:	6a 18                	push   $0x18
  802432:	e8 39 fd ff ff       	call   802170 <syscall>
  802437:	83 c4 18             	add    $0x18,%esp
}
  80243a:	c9                   	leave  
  80243b:	c3                   	ret    

0080243c <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80244b:	52                   	push   %edx
  80244c:	50                   	push   %eax
  80244d:	6a 1b                	push   $0x1b
  80244f:	e8 1c fd ff ff       	call   802170 <syscall>
  802454:	83 c4 18             	add    $0x18,%esp
}
  802457:	c9                   	leave  
  802458:	c3                   	ret    

00802459 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802468:	52                   	push   %edx
  802469:	50                   	push   %eax
  80246a:	6a 19                	push   $0x19
  80246c:	e8 ff fc ff ff       	call   802170 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  80248a:	e8 e1 fc ff ff       	call   802170 <syscall>
...
00802495 <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8024a1:	8b 4d 14             	mov    0x14(%ebp),%ecx
  8024a4:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8024b2:	50                   	push   %eax
  8024b3:	6a 1c                	push   $0x1c
  8024b5:	e8 b6 fc ff ff       	call   802170 <syscall>
  8024ba:	83 c4 18             	add    $0x18,%esp
}
  8024bd:	c9                   	leave  
  8024be:	c3                   	ret    

008024bf <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  8024ce:	52                   	push   %edx
  8024cf:	50                   	push   %eax
  8024d0:	6a 1d                	push   $0x1d
  8024d2:	e8 99 fc ff ff       	call   802170 <syscall>
  8024d7:	83 c4 18             	add    $0x18,%esp
}
  8024da:	c9                   	leave  
  8024db:	c3                   	ret    

008024dc <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  8024df:	8b 4d 10             	mov    0x10(%ebp),%ecx
  ...
  8024ed:	52                   	push   %edx
  8024ee:	50                   	push   %eax
  8024ef:	6a 1e                	push   $0x1e
  8024f1:	e8 7a fc ff ff       	call   802170 <syscall>
  8024f6:	83 c4 18             	add    $0x18,%esp
}
  8024f9:	c9                   	leave  
  8024fa:	c3                   	ret    

008024fb <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  80250a:	52                   	push   %edx
  80250b:	50                   	push   %eax
  80250c:	6a 1f                	push   $0x1f
  80250e:	e8 5d fc ff ff       	call   802170 <syscall>
  802513:	83 c4 18             	add    $0x18,%esp
}
  802516:	c9                   	leave  
  802517:	c3                   	ret    

00802518 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  802525:	6a 20                	push   $0x20
  802527:	e8 44 fc ff ff       	call   802170 <syscall>
  80252c:	83 c4 18             	add    $0x18,%esp
}
  80252f:	c9                   	leave  
  802530:	c3                   	ret    

00802531 <sys_create_env>:
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  802539:	ff 75 14             	pushl  0x14(%ebp)
  80253c:	ff 75 10             	pushl  0x10(%ebp)
  80253f:	ff 75 0c             	pushl  0xc(%ebp)
  802542:	50                   	push   %eax
  802543:	6a 21                	push   $0x21
  802545:	e8 26 fc ff ff       	call   802170 <syscall>
  80254a:	83 c4 18             	add    $0x18,%esp
}
  80254d:	c9                   	leave  
  80254e:	c3                   	ret    

0080254f <sys_run_env>:
...
sys_run_env(int32 envId)
{
  ...
  80255d:	50                   	push   %eax
  80255e:	6a 22                	push   $0x22
  802560:	e8 0b fc ff ff       	call   802170 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  802579:	50                   	push   %eax
  80257a:	6a 23                	push   $0x23
  80257c:	e8 ef fb ff ff       	call   802170 <syscall>
...
sys_get_virtual_time()
{
  ...
  80258d:	8d 45 f8             	lea    -0x8(%ebp),%eax
  802590:	8d 50 04             	lea    0x4(%eax),%edx
  ...
  80259c:	52                   	push   %edx
  80259d:	50                   	push   %eax
  80259e:	6a 24                	push   $0x24
  8025a0:	e8 cb fb ff ff       	call   802170 <syscall>
  8025a5:	83 c4 18             	add    $0x18,%esp
	return result;
  8025a8:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8025ab:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8025ae:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8025b1:	89 01                	mov    %eax,(%ecx)
  8025b3:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8025b6:	8b 45 08             	mov    0x8(%ebp),%eax
  8025b9:	c9                   	leave  
  8025ba:	c2 04 00             	ret    $0x4

008025bd <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  8025cd:	6a 13                	push   $0x13
  8025cf:	e8 9c fb ff ff       	call   802170 <syscall>
...
uint32 sys_rcr2()
{
  ...
  8025e7:	6a 25                	push   $0x25
  8025e9:	e8 82 fb ff ff       	call   802170 <syscall>
  8025ee:	83 c4 18             	add    $0x18,%esp
}
  8025f1:	c9                   	leave  
  8025f2:	c3                   	ret    

008025f3 <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  8025fc:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_bypassPageFault, instrLength, 0, 0, 0, 0);
  8025ff:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  ...
  80260e:	e8 5d fb ff ff       	call   802170 <syscall>
...
void rsttst()
{
  ...
  802626:	6a 28                	push   $0x28
  802628:	e8 43 fb ff ff       	call   802170 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  802639:	8b 45 14             	mov    0x14(%ebp),%eax
  80263c:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_testNum, n, v1, v2, c, inv);
  80263f:	8b 55 18             	mov    0x18(%ebp),%edx
  802642:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  802646:	52                   	push   %edx
  802647:	50                   	push   %eax
  802648:	ff 75 10             	pushl  0x10(%ebp)
  80264b:	ff 75 0c             	pushl  0xc(%ebp)
  80264e:	ff 75 08             	pushl  0x8(%ebp)
  802651:	6a 27                	push   $0x27
  802653:	e8 18 fb ff ff       	call   802170 <syscall>
...
void chktst(uint32 n)
{
  ...
  80266c:	6a 29                	push   $0x29
  80266e:	e8 fd fa ff ff       	call   802170 <syscall>
...
void inctst()
{
  ...
  802686:	6a 2a                	push   $0x2a
  802688:	e8 e3 fa ff ff       	call   802170 <syscall>
...
uint32 gettst()
{
  ...
  8026a0:	6a 2b                	push   $0x2b
  8026a2:	e8 c9 fa ff ff       	call   802170 <syscall>
  8026a7:	83 c4 18             	add    $0x18,%esp
}
  8026aa:	c9                   	leave  
  8026ab:	c3                   	ret    

008026ac <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8026be:	e8 ad fa ff ff       	call   802170 <syscall>
  8026c3:	83 c4 18             	add    $0x18,%esp
  8026c6:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  8026c9:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  8026cd:	75 07                	jne    8026d6 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  8026cf:	b8 01 00 00 00       	mov    $0x1,%eax
  8026d4:	eb 05                	jmp    8026db <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
008026dd <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  8026ef:	e8 7c fa ff ff       	call   802170 <syscall>
  8026f4:	83 c4 18             	add    $0x18,%esp
  8026f7:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  8026fa:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  8026fe:	75 07                	jne    802707 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  802700:	b8 01 00 00 00       	mov    $0x1,%eax
  802705:	eb 05                	jmp    80270c <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
0080270e <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  802720:	e8 4b fa ff ff       	call   802170 <syscall>
  802725:	83 c4 18             	add    $0x18,%esp
  802728:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  80272b:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  80272f:	75 07                	jne    802738 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  802731:	b8 01 00 00 00       	mov    $0x1,%eax
  802736:	eb 05                	jmp    80273d <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
0080273f <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  80273f:	55                   	push   %ebp
  802740:	89 e5                	mov    %esp,%ebp
  802742:	83 ec 10             	sub    $0x10,%esp
	uint32 ret = syscall(SYS_get_heap_strategy, 0, 0, 0, 0, 0);
  ...
  80274f:	6a 2c                	push   $0x2c
  802751:	e8 1a fa ff ff       	call   802170 <syscall>
  802756:	83 c4 18             	add    $0x18,%esp
  802759:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  80275c:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  802760:	75 07                	jne    802769 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  802762:	b8 01 00 00 00       	mov    $0x1,%eax
  802767:	eb 05                	jmp    80276e <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
00802770 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  80277e:	6a 2d                	push   $0x2d
  802780:	e8 eb f9 ff ff       	call   802170 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  80278f:	8b 5d 14             	mov    0x14(%ebp),%ebx
  802792:	8b 4d 10             	mov    0x10(%ebp),%ecx
  802795:	8b 55 0c             	mov    0xc(%ebp),%edx
  ...
  80279f:	52                   	push   %edx
  8027a0:	50                   	push   %eax
  8027a1:	6a 2e                	push   $0x2e
  8027a3:	e8 c8 f9 ff ff       	call   802170 <syscall>
  8027a8:	83 c4 18             	add    $0x18,%esp
}
  8027ab:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8027ae:	c9                   	leave  
  8027af:	c3                   	ret    

008027b0 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8027bf:	52                   	push   %edx
  8027c0:	50                   	push   %eax
  8027c1:	6a 2f                	push   $0x2f
  8027c3:	e8 a8 f9 ff ff       	call   802170 <syscall>
...
008027d0 <__udivdi3>:
  ...
  8027d7:	8b 5c 24 30          	mov    0x30(%esp),%ebx
  8027db:	8b 4c 24 34          	mov    0x34(%esp),%ecx
  8027df:	8b 7c 24 38          	mov    0x38(%esp),%edi
  8027e3:	89 5c 24 08          	mov    %ebx,0x8(%esp)
  8027e7:	89 ca                	mov    %ecx,%edx
  8027e9:	89 f8                	mov    %edi,%eax
  8027eb:	8b 74 24 3c          	mov    0x3c(%esp),%esi
  8027ef:	85 f6                	test   %esi,%esi
  8027f1:	75 2d                	jne    802820 <__udivdi3+0x50>
  8027f3:	39 cf                	cmp    %ecx,%edi
  8027f5:	77 65                	ja     80285c <__udivdi3+0x8c>
  8027f7:	89 fd                	mov    %edi,%ebp
  8027f9:	85 ff                	test   %edi,%edi
  8027fb:	75 0b                	jne    802808 <__udivdi3+0x38>
  8027fd:	b8 01 00 00 00       	mov    $0x1,%eax
  802802:	31 d2                	xor    %edx,%edx
  802804:	f7 f7                	div    %edi
  802806:	89 c5                	mov    %eax,%ebp
  802808:	31 d2                	xor    %edx,%edx
  80280a:	89 c8                	mov    %ecx,%eax
  80280c:	f7 f5                	div    %ebp
  80280e:	89 c1                	mov    %eax,%ecx
  802810:	89 d8                	mov    %ebx,%eax
  802812:	f7 f5                	div    %ebp
  802814:	89 cf                	mov    %ecx,%edi
  ...
  802822:	77 28                	ja     80284c <__udivdi3+0x7c>
  802824:	0f bd fe             	bsr    %esi,%edi
  802827:	83 f7 1f             	xor    $0x1f,%edi
  80282a:	75 40                	jne    80286c <__udivdi3+0x9c>
  80282c:	39 ce                	cmp    %ecx,%esi
  80282e:	72 0a                	jb     80283a <__udivdi3+0x6a>
  802830:	3b 44 24 08          	cmp    0x8(%esp),%eax
  802834:	0f 87 9e 00 00 00    	ja     8028d8 <__udivdi3+0x108>
  ...
  80286a:	5d                   	pop    %ebp
  80286b:	c3                   	ret    
  80286c:	bd 20 00 00 00       	mov    $0x20,%ebp
  802871:	89 eb                	mov    %ebp,%ebx
  802873:	29 fb                	sub    %edi,%ebx
  802875:	89 f9                	mov    %edi,%ecx
  802877:	d3 e6                	shl    %cl,%esi
  802879:	89 c5                	mov    %eax,%ebp
  80287b:	88 d9                	mov    %bl,%cl
  80287d:	d3 ed                	shr    %cl,%ebp
  80287f:	89 e9                	mov    %ebp,%ecx
  802881:	09 f1                	or     %esi,%ecx
  802883:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
  802887:	89 f9                	mov    %edi,%ecx
  802889:	d3 e0                	shl    %cl,%eax
  80288b:	89 c5                	mov    %eax,%ebp
  80288d:	89 d6                	mov    %edx,%esi
  80288f:	88 d9                	mov    %bl,%cl
  802891:	d3 ee                	shr    %cl,%esi
  ...
  80289f:	09 c2                	or     %eax,%edx
  8028a1:	89 d0                	mov    %edx,%eax
  8028a3:	89 f2                	mov    %esi,%edx
  8028a5:	f7 74 24 0c          	divl   0xc(%esp)
  8028a9:	89 d6                	mov    %edx,%esi
  8028ab:	89 c3                	mov    %eax,%ebx
  8028ad:	f7 e5                	mul    %ebp
  8028af:	39 d6                	cmp    %edx,%esi
  8028b1:	72 19                	jb     8028cc <__udivdi3+0xfc>
  8028b3:	74 0b                	je     8028c0 <__udivdi3+0xf0>
  8028b5:	89 d8                	mov    %ebx,%eax
  8028b7:	31 ff                	xor    %edi,%edi
  8028b9:	e9 58 ff ff ff       	jmp    802816 <__udivdi3+0x46>
  8028be:	66 90                	xchg   %ax,%ax
  8028c0:	8b 54 24 08          	mov    0x8(%esp),%edx
  8028c4:	89 f9                	mov    %edi,%ecx
  8028c6:	d3 e2                	shl    %cl,%edx
  8028c8:	39 c2                	cmp    %eax,%edx
  8028ca:	73 e9                	jae    8028b5 <__udivdi3+0xe5>
  8028cc:	8d 43 ff             	lea    -0x1(%ebx),%eax
  8028cf:	31 ff                	xor    %edi,%edi
  8028d1:	e9 40 ff ff ff       	jmp    802816 <__udivdi3+0x46>
  8028d6:	66 90                	xchg   %ax,%ax
  8028d8:	31 c0                	xor    %eax,%eax
  8028da:	e9 37 ff ff ff       	jmp    802816 <__udivdi3+0x46>
  8028df:	90                   	nop
...
008028e0 <__umoddi3>:
  ...
  8028e7:	8b 4c 24 30          	mov    0x30(%esp),%ecx
  8028eb:	8b 74 24 34          	mov    0x34(%esp),%esi
  8028ef:	8b 7c 24 38          	mov    0x38(%esp),%edi
  8028f3:	8b 44 24 3c          	mov    0x3c(%esp),%eax
  8028f7:	89 44 24 0c          	mov    %eax,0xc(%esp)
  8028fb:	89 4c 24 08          	mov    %ecx,0x8(%esp)
  8028ff:	89 f3                	mov    %esi,%ebx
  802901:	89 fa                	mov    %edi,%edx
  802903:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802907:	89 34 24             	mov    %esi,(%esp)
  80290a:	85 c0                	test   %eax,%eax
  80290c:	75 1a                	jne    802928 <__umoddi3+0x48>
  80290e:	39 f7                	cmp    %esi,%edi
  802910:	0f 86 a2 00 00 00    	jbe    8029b8 <__umoddi3+0xd8>
  802916:	89 c8                	mov    %ecx,%eax
  ...
  802926:	5d                   	pop    %ebp
  802927:	c3                   	ret    
  802928:	39 f0                	cmp    %esi,%eax
  80292a:	0f 87 ac 00 00 00    	ja     8029dc <__umoddi3+0xfc>
  802930:	0f bd e8             	bsr    %eax,%ebp
  802933:	83 f5 1f             	xor    $0x1f,%ebp
  802936:	0f 84 ac 00 00 00    	je     8029e8 <__umoddi3+0x108>
  80293c:	bf 20 00 00 00       	mov    $0x20,%edi
  802941:	29 ef                	sub    %ebp,%edi
  802943:	89 fe                	mov    %edi,%esi
  802945:	89 7c 24 0c          	mov    %edi,0xc(%esp)
  802949:	89 e9                	mov    %ebp,%ecx
  80294b:	d3 e0                	shl    %cl,%eax
  80294d:	89 d7                	mov    %edx,%edi
  80294f:	89 f1                	mov    %esi,%ecx
  802951:	d3 ef                	shr    %cl,%edi
  802953:	09 c7                	or     %eax,%edi
  802955:	89 e9                	mov    %ebp,%ecx
  802957:	d3 e2                	shl    %cl,%edx
  802959:	89 14 24             	mov    %edx,(%esp)
  80295c:	89 d8                	mov    %ebx,%eax
  80295e:	d3 e0                	shl    %cl,%eax
  802960:	89 c2                	mov    %eax,%edx
  802962:	8b 44 24 08          	mov    0x8(%esp),%eax
  802966:	d3 e0                	shl    %cl,%eax
  802968:	89 44 24 04          	mov    %eax,0x4(%esp)
  80296c:	8b 44 24 08          	mov    0x8(%esp),%eax
  802970:	89 f1                	mov    %esi,%ecx
  802972:	d3 e8                	shr    %cl,%eax
  802974:	09 d0                	or     %edx,%eax
  802976:	d3 eb                	shr    %cl,%ebx
  802978:	89 da                	mov    %ebx,%edx
  80297a:	f7 f7                	div    %edi
  80297c:	89 d3                	mov    %edx,%ebx
  80297e:	f7 24 24             	mull   (%esp)
  802981:	89 c6                	mov    %eax,%esi
  802983:	89 d1                	mov    %edx,%ecx
  802985:	39 d3                	cmp    %edx,%ebx
  802987:	0f 82 87 00 00 00    	jb     802a14 <__umoddi3+0x134>
  80298d:	0f 84 91 00 00 00    	je     802a24 <__umoddi3+0x144>
  802993:	8b 54 24 04          	mov    0x4(%esp),%edx
  802997:	29 f2                	sub    %esi,%edx
  802999:	19 cb                	sbb    %ecx,%ebx
  80299b:	89 d8                	mov    %ebx,%eax
  80299d:	8a 4c 24 0c          	mov    0xc(%esp),%cl
  8029a1:	d3 e0                	shl    %cl,%eax
  8029a3:	89 e9                	mov    %ebp,%ecx
  8029a5:	d3 ea                	shr    %cl,%edx
  8029a7:	09 d0                	or     %edx,%eax
  8029a9:	89 e9                	mov    %ebp,%ecx
  8029ab:	d3 eb                	shr    %cl,%ebx
  8029ad:	89 da                	mov    %ebx,%edx
  8029af:	83 c4 1c             	add    $0x1c,%esp
  8029b2:	5b                   	pop    %ebx
  8029b3:	5e                   	pop    %esi
  8029b4:	5f                   	pop    %edi
  8029b5:	5d                   	pop    %ebp
  ...
  8029bc:	75 0b                	jne    8029c9 <__umoddi3+0xe9>
  ...
  8029d5:	e9 44 ff ff ff       	jmp    80291e <__umoddi3+0x3e>
  8029da:	66 90                	xchg   %ax,%ax
  8029dc:	89 c8                	mov    %ecx,%eax
  8029de:	89 f2                	mov    %esi,%edx
  ...
  8029e6:	5d                   	pop    %ebp
  8029e7:	c3                   	ret    
  8029e8:	3b 04 24             	cmp    (%esp),%eax
  8029eb:	72 06                	jb     8029f3 <__umoddi3+0x113>
  8029ed:	3b 7c 24 04          	cmp    0x4(%esp),%edi
  8029f1:	77 0f                	ja     802a02 <__umoddi3+0x122>
  8029f3:	89 f2                	mov    %esi,%edx
  8029f5:	29 f9                	sub    %edi,%ecx
  8029f7:	1b 54 24 0c          	sbb    0xc(%esp),%edx
  8029fb:	89 14 24             	mov    %edx,(%esp)
  8029fe:	89 4c 24 04          	mov    %ecx,0x4(%esp)
  802a02:	8b 44 24 04          	mov    0x4(%esp),%eax
  802a06:	8b 14 24             	mov    (%esp),%edx
  ...
  802a14:	2b 04 24             	sub    (%esp),%eax
  802a17:	19 fa                	sbb    %edi,%edx
  802a19:	89 d1                	mov    %edx,%ecx
  802a1b:	89 c6                	mov    %eax,%esi
  802a1d:	e9 71 ff ff ff       	jmp    802993 <__umoddi3+0xb3>
  802a22:	66 90                	xchg   %ax,%ax
  802a24:	39 44 24 04          	cmp    %eax,0x4(%esp)
  802a28:	72 ea                	jb     802a14 <__umoddi3+0x134>
  802a2a:	89 d9                	mov    %ebx,%ecx
  802a2c:	e9 62 ff ff ff       	jmp    802993 <__umoddi3+0xb3>

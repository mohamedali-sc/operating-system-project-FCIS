...
void _main(void)
{
  ...
  8003ae:	e8 e5 1b 00 00       	call   801f98 <sys_pf_calculate_allocated_pages>
  ...
  80040a:	e8 ea 17 00 00       	call   801bf9 <free>
  80040f:	83 c4 10             	add    $0x10,%esp
		free(y);
  800412:	83 ec 0c             	sub    $0xc,%esp
  800415:	ff 75 8c             	pushl  -0x74(%ebp)
  800418:	e8 dc 17 00 00       	call   801bf9 <free>
  80041d:	83 c4 10             	add    $0x10,%esp

		int freePages = sys_calculate_free_frames();
  800420:	e8 f0 1a 00 00       	call   801f15 <sys_calculate_free_frames>
...
libmain(int argc, char **argv)
{
  ...
  8005e0:	e8 65 18 00 00       	call   801e4a <sys_getenvindex>
  ...
  80065d:	e8 83 19 00 00       	call   801fe5 <sys_disable_interrupt>
	cprintf("**************************************\n");
  ...
  8006ee:	e8 0c 19 00 00       	call   801fff <sys_enable_interrupt>
...
destroy(void)
{
  ...
  800706:	e8 0b 17 00 00       	call   801e16 <sys_env_destroy>
...
exit(void)
{
  ...
  800714:	83 ec 08             	sub    $0x8,%esp
	sys_env_exit();
  800717:	e8 60 17 00 00       	call   801e7c <sys_env_exit>
}
  80071c:	90                   	nop
  80071d:	c9                   	leave  
  80071e:	c3                   	ret    
...
static void putch(int ch, struct printbuf *b) {
  ...
  800931:	51                   	push   %ecx
  800932:	52                   	push   %edx
  800933:	e8 9c 14 00 00       	call   801dd4 <sys_cputs>
...
int vcprintf(const char *fmt, va_list ap) {
  ...
  8009a9:	50                   	push   %eax
  8009aa:	e8 25 14 00 00       	call   801dd4 <sys_cputs>
...
int atomic_cprintf(const char *fmt, ...) {
  ...
  8009f1:	83 ec 18             	sub    $0x18,%esp
	sys_disable_interrupt();
  8009f4:	e8 ec 15 00 00       	call   801fe5 <sys_disable_interrupt>
	va_list ap;
	int cnt;
  ...
  800a11:	89 45 f0             	mov    %eax,-0x10(%ebp)
	...
	sys_enable_interrupt();
  800a14:	e8 e6 15 00 00       	call   801fff <sys_enable_interrupt>
	return cnt;
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800a5e:	e8 a5 19 00 00       	call   802408 <__udivdi3>
  ...
  800aac:	52                   	push   %edx
  800aad:	50                   	push   %eax
  800aae:	e8 65 1a 00 00       	call   802518 <__umoddi3>
...
//	while(size%PAGE_SIZE!=0){
  ...
  801811:	77 21                	ja     801834 <malloc+0xe9>
  ...
  801822:	76 10                	jbe    801834 <malloc+0xe9>
					ni=PAGE_SIZE;
  801824:	c7 45 ec 00 10 00 00 	movl   $0x1000,-0x14(%ebp)
					flag1=1;
  80182b:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
					break;
  801832:	eb 0d                	jmp    801841 <malloc+0xf6>
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		...
		for(int j=i;j<i+size;j+=PAGE_SIZE){
			for(int k=0;k<count;k++){
  801834:	ff 45 d8             	incl   -0x28(%ebp)
  801837:	a1 28 30 80 00       	mov    0x803028,%eax
  80183c:	39 45 d8             	cmp    %eax,-0x28(%ebp)
  80183f:	7c c1                	jl     801802 <malloc+0xb7>
					ni=PAGE_SIZE;
					flag1=1;
					break;
				}
			...
			if(flag1){
  801841:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
  801845:	74 09                	je     801850 <malloc+0x105>
				flag0=0;
  801847:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
				break;
  80184e:	eb 16                	jmp    801866 <malloc+0x11b>
		cprintf("arr %d end is: %x\n",i,arr_add[i].end);
	}
	...
	for(int i=USER_HEAP_START;i<(int)base_add;i+=ni){
		int flag0=1;
		for(int j=i;j<i+size;j+=PAGE_SIZE){
  801850:	81 45 dc 00 10 00 00 	addl   $0x1000,-0x24(%ebp)
  801857:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80185a:	8b 45 08             	mov    0x8(%ebp),%eax
  80185d:	01 c2                	add    %eax,%edx
  80185f:	8b 45 dc             	mov    -0x24(%ebp),%eax
  801862:	39 c2                	cmp    %eax,%edx
  801864:	77 93                	ja     8017f9 <malloc+0xae>
			if(flag1){
				flag0=0;
				break;
			}
		...
		if(flag0){
  801866:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
  80186a:	0f 84 a2 00 00 00    	je     801912 <malloc+0x1c7>

			int f=1;
  801870:	c7 45 d4 01 00 00 00 	movl   $0x1,-0x2c(%ebp)

			arr[count2].start=i;
  801877:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  80187a:	8b 4d f4             	mov    -0xc(%ebp),%ecx
  80187d:	89 c8                	mov    %ecx,%eax
  80187f:	01 c0                	add    %eax,%eax
  801881:	01 c8                	add    %ecx,%eax
  801883:	c1 e0 02             	shl    $0x2,%eax
  801886:	05 40 31 d0 00       	add    $0xd03140,%eax
  80188b:	89 10                	mov    %edx,(%eax)
			arr[count2].end = i+size;
  80188d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  801890:	8b 45 08             	mov    0x8(%ebp),%eax
  801893:	8d 0c 02             	lea    (%edx,%eax,1),%ecx
  801896:	8b 55 f4             	mov    -0xc(%ebp),%edx
  801899:	89 d0                	mov    %edx,%eax
  80189b:	01 c0                	add    %eax,%eax
  80189d:	01 d0                	add    %edx,%eax
  80189f:	c1 e0 02             	shl    $0x2,%eax
  8018a2:	05 44 31 d0 00       	add    $0xd03144,%eax
  8018a7:	89 08                	mov    %ecx,(%eax)
			arr[count2].space=0;
  ...
  8018b5:	05 48 31 d0 00       	add    $0xd03148,%eax
  8018ba:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
			count2++;
  8018c0:	ff 45 f4             	incl   -0xc(%ebp)

			for(int l=0;l<count;l++){
  8018c3:	c7 45 d0 00 00 00 00 	movl   $0x0,-0x30(%ebp)
  8018ca:	eb 36                	jmp    801902 <malloc+0x1b7>
				if(i+size<arr_add[l].start){
  8018cc:	8b 55 e4             	mov    -0x1c(%ebp),%edx
  8018cf:	8b 45 08             	mov    0x8(%ebp),%eax
  8018d2:	01 c2                	add    %eax,%edx
  8018d4:	8b 45 d0             	mov    -0x30(%ebp),%eax
  8018d7:	8b 04 c5 00 06 d2 00 	mov    0xd20600(,%eax,8),%eax
  8018de:	39 c2                	cmp    %eax,%edx
  8018e0:	73 1d                	jae    8018ff <malloc+0x1b4>
					ni=arr_add[l].end-i;
  8018e2:	8b 45 d0             	mov    -0x30(%ebp),%eax
  8018e5:	8b 14 c5 04 06 d2 00 	mov    0xd20604(,%eax,8),%edx
  8018ec:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  8018ef:	29 c2                	sub    %eax,%edx
  8018f1:	89 d0                	mov    %edx,%eax
  8018f3:	89 45 ec             	mov    %eax,-0x14(%ebp)
					f=0;
  8018f6:	c7 45 d4 00 00 00 00 	movl   $0x0,-0x2c(%ebp)
					break;
  8018fd:	eb 0d                	jmp    80190c <malloc+0x1c1>
			arr[count2].start=i;
			arr[count2].end = i+size;
			arr[count2].space=0;
			count2++;
			...
			for(int l=0;l<count;l++){
  8018ff:	ff 45 d0             	incl   -0x30(%ebp)
  801902:	a1 28 30 80 00       	mov    0x803028,%eax
  801907:	39 45 d0             	cmp    %eax,-0x30(%ebp)
  80190a:	7c c0                	jl     8018cc <malloc+0x181>
					break;
			...
			if(f){
  80190c:	83 7d d4 00          	cmpl   $0x0,-0x2c(%ebp)
  801910:	75 1d                	jne    80192f <malloc+0x1e4>
				break;
			}
  ...
  80191c:	01 45 e4             	add    %eax,-0x1c(%ebp)
  80191f:	a1 04 30 80 00       	mov    0x803004,%eax
  801924:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  801927:	0f 8c bd fe ff ff    	jl     8017ea <malloc+0x9f>
  80192d:	eb 01                	jmp    801930 <malloc+0x1e5>
  ...
  801934:	75 7a                	jne    8019b0 <malloc+0x265>
  ...
  801947:	7c 0a                	jl     801953 <malloc+0x208>
			return NULL;
  801949:	b8 00 00 00 00       	mov    $0x0,%eax
  80194e:	e9 a4 02 00 00       	jmp    801bf7 <malloc+0x4ac>
		else{
			uint32 s=base_add;
  801953:	a1 04 30 80 00       	mov    0x803004,%eax
  801958:	89 45 a4             	mov    %eax,-0x5c(%ebp)
			//cprintf("s: %x",s);
			arr_add[count].start=s;
  80195b:	a1 28 30 80 00       	mov    0x803028,%eax
  801960:	8b 55 a4             	mov    -0x5c(%ebp),%edx
  801963:	89 14 c5 00 06 d2 00 	mov    %edx,0xd20600(,%eax,8)
		    sys_allocateMem(s,size);
  80196a:	83 ec 08             	sub    $0x8,%esp
  80196d:	ff 75 08             	pushl  0x8(%ebp)
  801970:	ff 75 a4             	pushl  -0x5c(%ebp)
  801973:	e8 04 06 00 00       	call   801f7c <sys_allocateMem>
  801978:	83 c4 10             	add    $0x10,%esp
			base_add+=size;
  80197b:	8b 15 04 30 80 00    	mov    0x803004,%edx
  801981:	8b 45 08             	mov    0x8(%ebp),%eax
  801984:	01 d0                	add    %edx,%eax
  801986:	a3 04 30 80 00       	mov    %eax,0x803004
			arr_add[count].end=base_add;
  80198b:	a1 28 30 80 00       	mov    0x803028,%eax
  801990:	8b 15 04 30 80 00    	mov    0x803004,%edx
  801996:	89 14 c5 04 06 d2 00 	mov    %edx,0xd20604(,%eax,8)
			count++;
  80199d:	a1 28 30 80 00       	mov    0x803028,%eax
  8019a2:	40                   	inc    %eax
  8019a3:	a3 28 30 80 00       	mov    %eax,0x803028

			return (void*)s;
  8019a8:	8b 45 a4             	mov    -0x5c(%ebp),%eax
  8019ab:	e9 47 02 00 00       	jmp    801bf7 <malloc+0x4ac>
	}
	else{
  ...
  8019b0:	c7 45 cc 00 00 00 00 	movl   $0x0,-0x34(%ebp)
  8019b7:	e9 ac 00 00 00       	jmp    801a68 <malloc+0x31d>
  ...
  8019c8:	05 44 31 d0 00       	add    $0xd03144,%eax
  8019cd:	8b 00                	mov    (%eax),%eax
  8019cf:	89 45 c8             	mov    %eax,-0x38(%ebp)
  8019d2:	eb 7e                	jmp    801a52 <malloc+0x307>
			int flag=0;
  8019d4:	c7 45 c4 00 00 00 00 	movl   $0x0,-0x3c(%ebp)
			for(int k=0;k<count;k++){
  8019db:	c7 45 c0 00 00 00 00 	movl   $0x0,-0x40(%ebp)
  8019e2:	eb 57                	jmp    801a3b <malloc+0x2f0>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
  8019e4:	8b 45 c0             	mov    -0x40(%ebp),%eax
  8019e7:	8b 14 c5 00 06 d2 00 	mov    0xd20600(,%eax,8),%edx
  8019ee:	8b 45 c8             	mov    -0x38(%ebp),%eax
  8019f1:	39 c2                	cmp    %eax,%edx
  8019f3:	77 1a                	ja     801a0f <malloc+0x2c4>
  8019f5:	8b 45 c0             	mov    -0x40(%ebp),%eax
  8019f8:	8b 14 c5 04 06 d2 00 	mov    0xd20604(,%eax,8),%edx
  8019ff:	8b 45 c8             	mov    -0x38(%ebp),%eax
  801a02:	39 c2                	cmp    %eax,%edx
  801a04:	76 09                	jbe    801a0f <malloc+0x2c4>
								flag=1;
  801a06:	c7 45 c4 01 00 00 00 	movl   $0x1,-0x3c(%ebp)
								break;}
  801a0d:	eb 36                	jmp    801a45 <malloc+0x2fa>
			arr[i].space++;
  801a0f:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801a12:	89 d0                	mov    %edx,%eax
  801a14:	01 c0                	add    %eax,%eax
  801a16:	01 d0                	add    %edx,%eax
  801a18:	c1 e0 02             	shl    $0x2,%eax
  801a1b:	05 48 31 d0 00       	add    $0xd03148,%eax
  801a20:	8b 00                	mov    (%eax),%eax
  801a22:	8d 48 01             	lea    0x1(%eax),%ecx
  801a25:	8b 55 cc             	mov    -0x34(%ebp),%edx
  801a28:	89 d0                	mov    %edx,%eax
  801a2a:	01 c0                	add    %eax,%eax
  801a2c:	01 d0                	add    %edx,%eax
  801a2e:	c1 e0 02             	shl    $0x2,%eax
  801a31:	05 48 31 d0 00       	add    $0xd03148,%eax
  801a36:	89 08                	mov    %ecx,(%eax)
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
			int flag=0;
			for(int k=0;k<count;k++){
  801a38:	ff 45 c0             	incl   -0x40(%ebp)
  801a3b:	a1 28 30 80 00       	mov    0x803028,%eax
  801a40:	39 45 c0             	cmp    %eax,-0x40(%ebp)
  801a43:	7c 9f                	jl     8019e4 <malloc+0x299>
				if(j>=arr_add[k].start&&j<arr_add[k].end){
								flag=1;
								break;}
			arr[i].space++;
			...
			if(flag)
  801a45:	83 7d c4 00          	cmpl   $0x0,-0x3c(%ebp)
  801a49:	75 19                	jne    801a64 <malloc+0x319>
	else{
	...
	for(int i=0;i<count2;i++){
		for(int j=arr[i].end;j<base_add;j+=PAGE_SIZE){
  801a4b:	81 45 c8 00 10 00 00 	addl   $0x1000,-0x38(%ebp)
  801a52:	8b 55 c8             	mov    -0x38(%ebp),%edx
  801a55:	a1 04 30 80 00       	mov    0x803004,%eax
  801a5a:	39 c2                	cmp    %eax,%edx
  801a5c:	0f 82 72 ff ff ff    	jb     8019d4 <malloc+0x289>
  801a62:	eb 01                	jmp    801a65 <malloc+0x31a>
								flag=1;
								break;}
			arr[i].space++;
			}
  ...
  801a64:	90                   	nop
	...
	for(int i=0;i<count2;i++){
  801a65:	ff 45 cc             	incl   -0x34(%ebp)
  801a68:	8b 45 cc             	mov    -0x34(%ebp),%eax
  801a6b:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801a6e:	0f 8c 48 ff ff ff    	jl     8019bc <malloc+0x271>
			if(flag)
				break;
		}
	}
	...
	int index=0;
  801a74:	c7 45 bc 00 00 00 00 	movl   $0x0,-0x44(%ebp)
	int min=9999999;
  801a7b:	c7 45 b8 7f 96 98 00 	movl   $0x98967f,-0x48(%ebp)
	for(int i=0;i<count2;i++){
  801a82:	c7 45 b4 00 00 00 00 	movl   $0x0,-0x4c(%ebp)
  801a89:	eb 37                	jmp    801ac2 <malloc+0x377>
		//cprintf("arr %d size is: %x\n",i,arr[i].space);
		if(arr[i].space<min){
  801a8b:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  801a8e:	89 d0                	mov    %edx,%eax
  801a90:	01 c0                	add    %eax,%eax
  801a92:	01 d0                	add    %edx,%eax
  801a94:	c1 e0 02             	shl    $0x2,%eax
  801a97:	05 48 31 d0 00       	add    $0xd03148,%eax
  801a9c:	8b 00                	mov    (%eax),%eax
  801a9e:	3b 45 b8             	cmp    -0x48(%ebp),%eax
  801aa1:	7d 1c                	jge    801abf <malloc+0x374>
			//cprintf("arr %d size is: %x\n",i,min);
			min=arr[i].space;
  801aa3:	8b 55 b4             	mov    -0x4c(%ebp),%edx
  801aa6:	89 d0                	mov    %edx,%eax
  801aa8:	01 c0                	add    %eax,%eax
  801aaa:	01 d0                	add    %edx,%eax
  801aac:	c1 e0 02             	shl    $0x2,%eax
  801aaf:	05 48 31 d0 00       	add    $0xd03148,%eax
  801ab4:	8b 00                	mov    (%eax),%eax
  801ab6:	89 45 b8             	mov    %eax,-0x48(%ebp)
			index=i;
  801ab9:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801abc:	89 45 bc             	mov    %eax,-0x44(%ebp)
		}
	}
	...
	int min=9999999;
	for(int i=0;i<count2;i++){
  801abf:	ff 45 b4             	incl   -0x4c(%ebp)
  801ac2:	8b 45 b4             	mov    -0x4c(%ebp),%eax
  801ac5:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801ac8:	7c c1                	jl     801a8b <malloc+0x340>
			//cprintf("arr %d size is: %x\n",i,min);
  ...
  801aca:	8b 15 28 30 80 00    	mov    0x803028,%edx
  801ad0:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  801ad3:	89 c8                	mov    %ecx,%eax
  801ad5:	01 c0                	add    %eax,%eax
  801ad7:	01 c8                	add    %ecx,%eax
  801ad9:	c1 e0 02             	shl    $0x2,%eax
  801adc:	05 40 31 d0 00       	add    $0xd03140,%eax
  801ae1:	8b 00                	mov    (%eax),%eax
  801ae3:	89 04 d5 00 06 d2 00 	mov    %eax,0xd20600(,%edx,8)
	arr_add[count].end=arr[index].end;
  801aea:	8b 15 28 30 80 00    	mov    0x803028,%edx
  801af0:	8b 4d bc             	mov    -0x44(%ebp),%ecx
  801af3:	89 c8                	mov    %ecx,%eax
  801af5:	01 c0                	add    %eax,%eax
  801af7:	01 c8                	add    %ecx,%eax
  801af9:	c1 e0 02             	shl    $0x2,%eax
  801afc:	05 44 31 d0 00       	add    $0xd03144,%eax
  801b01:	8b 00                	mov    (%eax),%eax
  801b03:	89 04 d5 04 06 d2 00 	mov    %eax,0xd20604(,%edx,8)
	count++;
  801b0a:	a1 28 30 80 00       	mov    0x803028,%eax
  801b0f:	40                   	inc    %eax
  801b10:	a3 28 30 80 00       	mov    %eax,0x803028


		sys_allocateMem(arr[index].start,size);
  801b15:	8b 55 bc             	mov    -0x44(%ebp),%edx
  801b18:	89 d0                	mov    %edx,%eax
  801b1a:	01 c0                	add    %eax,%eax
  801b1c:	01 d0                	add    %edx,%eax
  801b1e:	c1 e0 02             	shl    $0x2,%eax
  801b21:	05 40 31 d0 00       	add    $0xd03140,%eax
  801b26:	8b 00                	mov    (%eax),%eax
  801b28:	83 ec 08             	sub    $0x8,%esp
  801b2b:	ff 75 08             	pushl  0x8(%ebp)
  801b2e:	50                   	push   %eax
  801b2f:	e8 48 04 00 00       	call   801f7c <sys_allocateMem>
  801b34:	83 c4 10             	add    $0x10,%esp

		for(int i=0;i<count2;i++){
  801b37:	c7 45 b0 00 00 00 00 	movl   $0x0,-0x50(%ebp)
  801b3e:	eb 78                	jmp    801bb8 <malloc+0x46d>

			cprintf("arr %d start is: %x\n",i,arr[i].start);
  801b40:	8b 55 b0             	mov    -0x50(%ebp),%edx
  801b43:	89 d0                	mov    %edx,%eax
  801b45:	01 c0                	add    %eax,%eax
  801b47:	01 d0                	add    %edx,%eax
  801b49:	c1 e0 02             	shl    $0x2,%eax
  801b4c:	05 40 31 d0 00       	add    $0xd03140,%eax
  801b51:	8b 00                	mov    (%eax),%eax
  801b53:	83 ec 04             	sub    $0x4,%esp
  801b56:	50                   	push   %eax
  801b57:	ff 75 b0             	pushl  -0x50(%ebp)
  801b5a:	68 b0 2e 80 00       	push   $0x802eb0
  801b5f:	e8 5d ee ff ff       	call   8009c1 <cprintf>
  801b64:	83 c4 10             	add    $0x10,%esp
			cprintf("arr %d end is: %x\n",i,arr[i].end);
  801b67:	8b 55 b0             	mov    -0x50(%ebp),%edx
  801b6a:	89 d0                	mov    %edx,%eax
  801b6c:	01 c0                	add    %eax,%eax
  801b6e:	01 d0                	add    %edx,%eax
  801b70:	c1 e0 02             	shl    $0x2,%eax
  801b73:	05 44 31 d0 00       	add    $0xd03144,%eax
  801b78:	8b 00                	mov    (%eax),%eax
  801b7a:	83 ec 04             	sub    $0x4,%esp
  801b7d:	50                   	push   %eax
  801b7e:	ff 75 b0             	pushl  -0x50(%ebp)
  801b81:	68 c5 2e 80 00       	push   $0x802ec5
  801b86:	e8 36 ee ff ff       	call   8009c1 <cprintf>
  ...
  801b9a:	05 48 31 d0 00       	add    $0xd03148,%eax
  801b9f:	8b 00                	mov    (%eax),%eax
  801ba1:	83 ec 04             	sub    $0x4,%esp
  801ba4:	50                   	push   %eax
  801ba5:	ff 75 b0             	pushl  -0x50(%ebp)
  801ba8:	68 d8 2e 80 00       	push   $0x802ed8
  801bad:	e8 0f ee ff ff       	call   8009c1 <cprintf>
  801bb2:	83 c4 10             	add    $0x10,%esp
	count++;
		...
		for(int i=0;i<count2;i++){
  801bb5:	ff 45 b0             	incl   -0x50(%ebp)
  801bb8:	8b 45 b0             	mov    -0x50(%ebp),%eax
  801bbb:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  801bbe:	7c 80                	jl     801b40 <malloc+0x3f5>
			cprintf("arr %d start is: %x\n",i,arr[i].start);
			cprintf("arr %d end is: %x\n",i,arr[i].end);
			cprintf("arr %d size is: %d\n",i,arr[i].space);
			}
...
void free(void* virtual_address)
{
  ...
  801c02:	89 45 e4             	mov    %eax,-0x1c(%ebp)
		...
		for(int i=0;i<count;i++){
  801c05:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  801c0c:	eb 4b                	jmp    801c59 <free+0x60>
			if((int)v>=(int)arr_add[i].start&&(int)v<(int)arr_add[i].end){
  801c0e:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c11:	8b 04 c5 00 06 d2 00 	mov    0xd20600(,%eax,8),%eax
  801c18:	89 c2                	mov    %eax,%edx
  801c1a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801c1d:	39 c2                	cmp    %eax,%edx
  801c1f:	7f 35                	jg     801c56 <free+0x5d>
  801c21:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c24:	8b 04 c5 04 06 d2 00 	mov    0xd20604(,%eax,8),%eax
  801c2b:	89 c2                	mov    %eax,%edx
  801c2d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  801c30:	39 c2                	cmp    %eax,%edx
  801c32:	7e 22                	jle    801c56 <free+0x5d>
				start=arr_add[i].start;
  801c34:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c37:	8b 04 c5 00 06 d2 00 	mov    0xd20600(,%eax,8),%eax
  801c3e:	89 45 f4             	mov    %eax,-0xc(%ebp)
				end=arr_add[i].end;
  801c41:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c44:	8b 04 c5 04 06 d2 00 	mov    0xd20604(,%eax,8),%eax
  801c4b:	89 45 e0             	mov    %eax,-0x20(%ebp)
				index=i;
  801c4e:	8b 45 ec             	mov    -0x14(%ebp),%eax
  801c51:	89 45 f0             	mov    %eax,-0x10(%ebp)
				break;
  801c54:	eb 0d                	jmp    801c63 <free+0x6a>
		...
		for(int i=0;i<count;i++){
  801c56:	ff 45 ec             	incl   -0x14(%ebp)
  801c59:	a1 28 30 80 00       	mov    0x803028,%eax
  801c5e:	39 45 ec             	cmp    %eax,-0x14(%ebp)
  801c61:	7c ab                	jl     801c0e <free+0x15>
				break;
			}
		}
  ...
  801c66:	8b 14 c5 04 06 d2 00 	mov    0xd20604(,%eax,8),%edx
  801c6d:	8b 45 f0             	mov    -0x10(%ebp),%eax
  801c70:	8b 04 c5 00 06 d2 00 	mov    0xd20600(,%eax,8),%eax
  801c77:	29 c2                	sub    %eax,%edx
  801c79:	89 d0                	mov    %edx,%eax
  801c7b:	83 ec 08             	sub    $0x8,%esp
  801c7e:	50                   	push   %eax
  801c7f:	ff 75 f4             	pushl  -0xc(%ebp)
  801c82:	e8 d9 02 00 00       	call   801f60 <sys_freeMem>
  ...
  801c90:	eb 2d                	jmp    801cbf <free+0xc6>
			arr_add[i].start=arr_add[i+1].start;
  801c92:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801c95:	40                   	inc    %eax
  801c96:	8b 14 c5 00 06 d2 00 	mov    0xd20600(,%eax,8),%edx
  801c9d:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801ca0:	89 14 c5 00 06 d2 00 	mov    %edx,0xd20600(,%eax,8)
			arr_add[i].end=arr_add[i+1].end;
  801ca7:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801caa:	40                   	inc    %eax
  801cab:	8b 14 c5 04 06 d2 00 	mov    0xd20604(,%eax,8),%edx
  801cb2:	8b 45 e8             	mov    -0x18(%ebp),%eax
  801cb5:	89 14 c5 04 06 d2 00 	mov    %edx,0xd20604(,%eax,8)
		...
		for(int i=index;i<count-1;i++){
  801cbc:	ff 45 e8             	incl   -0x18(%ebp)
  801cbf:	a1 28 30 80 00       	mov    0x803028,%eax
  801cc4:	48                   	dec    %eax
  801cc5:	3b 45 e8             	cmp    -0x18(%ebp),%eax
  801cc8:	7f c8                	jg     801c92 <free+0x99>
			arr_add[i].start=arr_add[i+1].start;
			arr_add[i].end=arr_add[i+1].end;
		}

		count--;
  801cca:	a1 28 30 80 00       	mov    0x803028,%eax
  801ccf:	48                   	dec    %eax
  801cd0:	a3 28 30 80 00       	mov    %eax,0x803028
...
void* smalloc(char *sharedVarName, uint32 size, uint8 isWritable)
{
  ...
  801ce1:	88 45 f4             	mov    %al,-0xc(%ebp)
	panic("this function is not required...!!");
  801ce4:	83 ec 04             	sub    $0x4,%esp
  801ce7:	68 08 2f 80 00       	push   $0x802f08
  801cec:	68 18 01 00 00       	push   $0x118
  801cf1:	68 2b 2f 80 00       	push   $0x802f2b
  801cf6:	e8 24 ea ff ff       	call   80071f <_panic>
...
void* sget(int32 ownerEnvID, char *sharedVarName)
{
  ...
  801d04:	68 08 2f 80 00       	push   $0x802f08
  801d09:	68 1e 01 00 00       	push   $0x11e
  801d0e:	68 2b 2f 80 00       	push   $0x802f2b
  801d13:	e8 07 ea ff ff       	call   80071f <_panic>
...
void sfree(void* virtual_address)
{
  ...
  801d21:	68 08 2f 80 00       	push   $0x802f08
  801d26:	68 24 01 00 00       	push   $0x124
  801d2b:	68 2b 2f 80 00       	push   $0x802f2b
  801d30:	e8 ea e9 ff ff       	call   80071f <_panic>
...
void *realloc(void *virtual_address, uint32 new_size)
{
  ...
  801d3e:	68 08 2f 80 00       	push   $0x802f08
  801d43:	68 29 01 00 00       	push   $0x129
  801d48:	68 2b 2f 80 00       	push   $0x802f2b
  801d4d:	e8 cd e9 ff ff       	call   80071f <_panic>
...
void expand(uint32 newSize)
{
  ...
  801d5b:	68 08 2f 80 00       	push   $0x802f08
  801d60:	68 2f 01 00 00       	push   $0x12f
  801d65:	68 2b 2f 80 00       	push   $0x802f2b
  801d6a:	e8 b0 e9 ff ff       	call   80071f <_panic>
...
void shrink(uint32 newSize)
{
  ...
  801d78:	68 08 2f 80 00       	push   $0x802f08
  801d7d:	68 33 01 00 00       	push   $0x133
  801d82:	68 2b 2f 80 00       	push   $0x802f2b
  801d87:	e8 93 e9 ff ff       	call   80071f <_panic>
...
void freeHeap(void* virtual_address)
{
  ...
  801d95:	68 08 2f 80 00       	push   $0x802f08
  801d9a:	68 38 01 00 00       	push   $0x138
  801d9f:	68 2b 2f 80 00       	push   $0x802f2b
  801da4:	e8 76 e9 ff ff       	call   80071f <_panic>
...
syscall(int num, uint32 a1, uint32 a2, uint32 a3, uint32 a4, uint32 a5)
{
  ...
  801dbe:	8b 7d 18             	mov    0x18(%ebp),%edi
  801dc1:	8b 75 1c             	mov    0x1c(%ebp),%esi
  801dc4:	cd 30                	int    $0x30
...
sys_cputs(const char *s, uint32 len, uint8 printProgName)
{
  ...
  801df2:	e8 b2 ff ff ff       	call   801da9 <syscall>
...
sys_cgetc(void)
{
  ...
  801e0c:	e8 98 ff ff ff       	call   801da9 <syscall>
  801e11:	83 c4 18             	add    $0x18,%esp
}
  801e14:	c9                   	leave  
  801e15:	c3                   	ret    

00801e16 <sys_env_destroy>:
...
int sys_env_destroy(int32  envid)
{
  ...
  801e24:	50                   	push   %eax
  801e25:	6a 05                	push   $0x5
  801e27:	e8 7d ff ff ff       	call   801da9 <syscall>
  801e2c:	83 c4 18             	add    $0x18,%esp
}
  801e2f:	c9                   	leave  
  801e30:	c3                   	ret    

00801e31 <sys_getenvid>:
...
int32 sys_getenvid(void)
{
  ...
  801e40:	e8 64 ff ff ff       	call   801da9 <syscall>
  801e45:	83 c4 18             	add    $0x18,%esp
}
  801e48:	c9                   	leave  
  801e49:	c3                   	ret    

00801e4a <sys_getenvindex>:
...
int32 sys_getenvindex(void)
{
  ...
  801e57:	6a 03                	push   $0x3
  801e59:	e8 4b ff ff ff       	call   801da9 <syscall>
  801e5e:	83 c4 18             	add    $0x18,%esp
}
  801e61:	c9                   	leave  
  801e62:	c3                   	ret    

00801e63 <sys_getparentenvid>:
...
int32 sys_getparentenvid(void)
{
  ...
  801e70:	6a 04                	push   $0x4
  801e72:	e8 32 ff ff ff       	call   801da9 <syscall>
  801e77:	83 c4 18             	add    $0x18,%esp
}
  801e7a:	c9                   	leave  
  801e7b:	c3                   	ret    

00801e7c <sys_env_exit>:
...
void sys_env_exit(void)
{
  ...
  801e8b:	e8 19 ff ff ff       	call   801da9 <syscall>
...
int __sys_allocate_page(void *va, int perm)
{
  ...
  801ea5:	52                   	push   %edx
  801ea6:	50                   	push   %eax
  801ea7:	6a 07                	push   $0x7
  801ea9:	e8 fb fe ff ff       	call   801da9 <syscall>
  801eae:	83 c4 18             	add    $0x18,%esp
}
  801eb1:	c9                   	leave  
  801eb2:	c3                   	ret    

00801eb3 <__sys_map_frame>:
...
int __sys_map_frame(int32 srcenv, void *srcva, int32 dstenv, void *dstva, int perm)
{
  ...
  801eb8:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  801ece:	e8 d6 fe ff ff       	call   801da9 <syscall>
...
int __sys_unmap_frame(int32 envid, void *va)
{
  ...
  801eec:	52                   	push   %edx
  801eed:	50                   	push   %eax
  801eee:	6a 09                	push   $0x9
  801ef0:	e8 b4 fe ff ff       	call   801da9 <syscall>
  801ef5:	83 c4 18             	add    $0x18,%esp
}
  801ef8:	c9                   	leave  
  801ef9:	c3                   	ret    

00801efa <sys_calculate_required_frames>:
...
uint32 sys_calculate_required_frames(uint32 start_virtual_address, uint32 size)
{
  ...
  801f09:	6a 0a                	push   $0xa
  801f0b:	e8 99 fe ff ff       	call   801da9 <syscall>
  801f10:	83 c4 18             	add    $0x18,%esp
}
  801f13:	c9                   	leave  
  801f14:	c3                   	ret    

00801f15 <sys_calculate_free_frames>:
...
uint32 sys_calculate_free_frames()
{
  ...
  801f22:	6a 0b                	push   $0xb
  801f24:	e8 80 fe ff ff       	call   801da9 <syscall>
  801f29:	83 c4 18             	add    $0x18,%esp
}
  801f2c:	c9                   	leave  
  801f2d:	c3                   	ret    

00801f2e <sys_calculate_modified_frames>:
uint32 sys_calculate_modified_frames()
{
  ...
  801f3b:	6a 0c                	push   $0xc
  801f3d:	e8 67 fe ff ff       	call   801da9 <syscall>
  801f42:	83 c4 18             	add    $0x18,%esp
}
  801f45:	c9                   	leave  
  801f46:	c3                   	ret    

00801f47 <sys_calculate_notmod_frames>:
...
uint32 sys_calculate_notmod_frames()
{
  ...
  801f54:	6a 0d                	push   $0xd
  801f56:	e8 4e fe ff ff       	call   801da9 <syscall>
  801f5b:	83 c4 18             	add    $0x18,%esp
}
  801f5e:	c9                   	leave  
  801f5f:	c3                   	ret    

00801f60 <sys_freeMem>:
...
void sys_freeMem(uint32 virtual_address, uint32 size)
{
  ...
  801f6f:	6a 11                	push   $0x11
  801f71:	e8 33 fe ff ff       	call   801da9 <syscall>
...
void sys_allocateMem(uint32 virtual_address, uint32 size)
{
  ...
  801f8b:	6a 12                	push   $0x12
  801f8d:	e8 17 fe ff ff       	call   801da9 <syscall>
...
00801f98 <sys_pf_calculate_allocated_pages>:
...
int sys_pf_calculate_allocated_pages()
{
  ...
  801fa5:	6a 0e                	push   $0xe
  801fa7:	e8 fd fd ff ff       	call   801da9 <syscall>
  801fac:	83 c4 18             	add    $0x18,%esp
}
  801faf:	c9                   	leave  
  801fb0:	c3                   	ret    

00801fb1 <sys_calculate_pages_tobe_removed_ready_exit>:
...
int sys_calculate_pages_tobe_removed_ready_exit(uint32 WS_or_MEMORY_flag)
{
  ...
  801fc1:	e8 e3 fd ff ff       	call   801da9 <syscall>
  801fc6:	83 c4 18             	add    $0x18,%esp
}
  801fc9:	c9                   	leave  
  801fca:	c3                   	ret    

00801fcb <sys_scarce_memory>:
...
void sys_scarce_memory()
{
  ...
  801fd8:	6a 10                	push   $0x10
  801fda:	e8 ca fd ff ff       	call   801da9 <syscall>
...
00801fe5 <sys_disable_interrupt>:
...
sys_disable_interrupt()
{
  ...
  801ff2:	6a 14                	push   $0x14
  801ff4:	e8 b0 fd ff ff       	call   801da9 <syscall>
...
sys_enable_interrupt()
{
  ...
  80200c:	6a 15                	push   $0x15
  80200e:	e8 96 fd ff ff       	call   801da9 <syscall>
...
sys_cputc(const char c)
{
  ...
  802022:	88 45 fc             	mov    %al,-0x4(%ebp)
	syscall(SYS_cputc, (uint32) c, 0, 0, 0, 0);
  802025:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  802029:	6a 00                	push   $0x0
  80202b:	6a 00                	push   $0x0
  80202d:	6a 00                	push   $0x0
  80202f:	6a 00                	push   $0x0
  802031:	50                   	push   %eax
  802032:	6a 16                	push   $0x16
  802034:	e8 70 fd ff ff       	call   801da9 <syscall>
...
sys_clear_ffl()
{
  ...
  80204c:	6a 17                	push   $0x17
  80204e:	e8 56 fd ff ff       	call   801da9 <syscall>
...
sys_createSemaphore(char* semaphoreName, uint32 initialValue)
{
  ...
  80206b:	e8 39 fd ff ff       	call   801da9 <syscall>
  802070:	83 c4 18             	add    $0x18,%esp
}
  802073:	c9                   	leave  
  802074:	c3                   	ret    

00802075 <sys_getSemaphoreValue>:
...
sys_getSemaphoreValue(int32 ownerEnvID, char* semaphoreName)
{
  ...
  802084:	52                   	push   %edx
  802085:	50                   	push   %eax
  802086:	6a 1b                	push   $0x1b
  802088:	e8 1c fd ff ff       	call   801da9 <syscall>
  80208d:	83 c4 18             	add    $0x18,%esp
}
  802090:	c9                   	leave  
  802091:	c3                   	ret    

00802092 <sys_waitSemaphore>:
...
sys_waitSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8020a1:	52                   	push   %edx
  8020a2:	50                   	push   %eax
  8020a3:	6a 19                	push   $0x19
  8020a5:	e8 ff fc ff ff       	call   801da9 <syscall>
...
sys_signalSemaphore(int32 ownerEnvID, char* semaphoreName)
{
  ...
  8020bf:	52                   	push   %edx
  8020c0:	50                   	push   %eax
  8020c1:	6a 1a                	push   $0x1a
  8020c3:	e8 e1 fc ff ff       	call   801da9 <syscall>
...
008020ce <sys_createSharedObject>:
...
sys_createSharedObject(char* shareName, uint32 size, uint8 isWritable, void* virtual_address)
{
  ...
  8020da:	8b 4d 14             	mov    0x14(%ebp),%ecx
  8020dd:	0f b6 55 fc          	movzbl -0x4(%ebp),%edx
  ...
  8020eb:	50                   	push   %eax
  8020ec:	6a 1c                	push   $0x1c
  8020ee:	e8 b6 fc ff ff       	call   801da9 <syscall>
  8020f3:	83 c4 18             	add    $0x18,%esp
}
  8020f6:	c9                   	leave  
  8020f7:	c3                   	ret    

008020f8 <sys_getSizeOfSharedObject>:
...
sys_getSizeOfSharedObject(int32 ownerID, char* shareName)
{
  ...
  802107:	52                   	push   %edx
  802108:	50                   	push   %eax
  802109:	6a 1d                	push   $0x1d
  80210b:	e8 99 fc ff ff       	call   801da9 <syscall>
  802110:	83 c4 18             	add    $0x18,%esp
}
  802113:	c9                   	leave  
  802114:	c3                   	ret    

00802115 <sys_getSharedObject>:
//==========
...
sys_getSharedObject(int32 ownerID, char* shareName, void* virtual_address)
{
  ...
  802126:	52                   	push   %edx
  802127:	50                   	push   %eax
  802128:	6a 1e                	push   $0x1e
  80212a:	e8 7a fc ff ff       	call   801da9 <syscall>
  80212f:	83 c4 18             	add    $0x18,%esp
}
  802132:	c9                   	leave  
  802133:	c3                   	ret    

00802134 <sys_freeSharedObject>:
...
sys_freeSharedObject(int32 sharedObjectID, void *startVA)
{
  ...
  802143:	52                   	push   %edx
  802144:	50                   	push   %eax
  802145:	6a 1f                	push   $0x1f
  802147:	e8 5d fc ff ff       	call   801da9 <syscall>
  80214c:	83 c4 18             	add    $0x18,%esp
}
  80214f:	c9                   	leave  
  802150:	c3                   	ret    

00802151 <sys_getMaxShares>:
...
uint32 	sys_getMaxShares()
{
  ...
  80215e:	6a 20                	push   $0x20
  802160:	e8 44 fc ff ff       	call   801da9 <syscall>
...
int sys_create_env(char* programName, unsigned int page_WS_size,unsigned int LRU_second_list_size,unsigned int percent_WS_pages_to_remove)
{
  ...
  80217b:	50                   	push   %eax
  80217c:	6a 21                	push   $0x21
  80217e:	e8 26 fc ff ff       	call   801da9 <syscall>
...
sys_run_env(int32 envId)
{
  ...
  802196:	50                   	push   %eax
  802197:	6a 22                	push   $0x22
  802199:	e8 0b fc ff ff       	call   801da9 <syscall>
...
sys_free_env(int32 envId)
{
  ...
  8021b2:	50                   	push   %eax
  8021b3:	6a 23                	push   $0x23
  8021b5:	e8 ef fb ff ff       	call   801da9 <syscall>
...
sys_get_virtual_time()
{
  ...
  8021c6:	8d 45 f8             	lea    -0x8(%ebp),%eax
  8021c9:	8d 50 04             	lea    0x4(%eax),%edx
  8021cc:	8d 45 f8             	lea    -0x8(%ebp),%eax
  8021cf:	6a 00                	push   $0x0
  8021d1:	6a 00                	push   $0x0
  8021d3:	6a 00                	push   $0x0
  8021d5:	52                   	push   %edx
  8021d6:	50                   	push   %eax
  8021d7:	6a 24                	push   $0x24
  8021d9:	e8 cb fb ff ff       	call   801da9 <syscall>
  8021de:	83 c4 18             	add    $0x18,%esp
	return result;
  8021e1:	8b 4d 08             	mov    0x8(%ebp),%ecx
  8021e4:	8b 45 f8             	mov    -0x8(%ebp),%eax
  8021e7:	8b 55 fc             	mov    -0x4(%ebp),%edx
  8021ea:	89 01                	mov    %eax,(%ecx)
  8021ec:	89 51 04             	mov    %edx,0x4(%ecx)
}
  8021ef:	8b 45 08             	mov    0x8(%ebp),%eax
  8021f2:	c9                   	leave  
  8021f3:	c2 04 00             	ret    $0x4

008021f6 <sys_moveMem>:
...
void sys_moveMem(uint32 src_virtual_address, uint32 dst_virtual_address, uint32 size)
{
  ...
  802206:	6a 13                	push   $0x13
  802208:	e8 9c fb ff ff       	call   801da9 <syscall>
...
uint32 sys_rcr2()
{
  ...
  802222:	e8 82 fb ff ff       	call   801da9 <syscall>
  802227:	83 c4 18             	add    $0x18,%esp
}
  80222a:	c9                   	leave  
  80222b:	c3                   	ret    

0080222c <sys_bypassPageFault>:
void sys_bypassPageFault(uint8 instrLength)
{
  ...
  802238:	0f b6 45 fc          	movzbl -0x4(%ebp),%eax
  80223c:	6a 00                	push   $0x0
  80223e:	6a 00                	push   $0x0
  802240:	6a 00                	push   $0x0
  802242:	6a 00                	push   $0x0
  802244:	50                   	push   %eax
  802245:	6a 26                	push   $0x26
  802247:	e8 5d fb ff ff       	call   801da9 <syscall>
...
void rsttst()
{
  ...
  80225f:	6a 28                	push   $0x28
  802261:	e8 43 fb ff ff       	call   801da9 <syscall>
...
void tst(uint32 n, uint32 v1, uint32 v2, char c, int inv)
{
  ...
  802278:	8b 55 18             	mov    0x18(%ebp),%edx
  80227b:	0f be 45 fc          	movsbl -0x4(%ebp),%eax
  80227f:	52                   	push   %edx
  802280:	50                   	push   %eax
  802281:	ff 75 10             	pushl  0x10(%ebp)
  802284:	ff 75 0c             	pushl  0xc(%ebp)
  802287:	ff 75 08             	pushl  0x8(%ebp)
  80228a:	6a 27                	push   $0x27
  80228c:	e8 18 fb ff ff       	call   801da9 <syscall>
...
void chktst(uint32 n)
{
  ...
  8022a5:	6a 29                	push   $0x29
  8022a7:	e8 fd fa ff ff       	call   801da9 <syscall>
...
void inctst()
{
  ...
  8022bf:	6a 2a                	push   $0x2a
  8022c1:	e8 e3 fa ff ff       	call   801da9 <syscall>
...
uint32 gettst()
{
  ...
  8022d9:	6a 2b                	push   $0x2b
  8022db:	e8 c9 fa ff ff       	call   801da9 <syscall>
  8022e0:	83 c4 18             	add    $0x18,%esp
}
  8022e3:	c9                   	leave  
  8022e4:	c3                   	ret    

008022e5 <sys_isUHeapPlacementStrategyFIRSTFIT>:
...
uint32 sys_isUHeapPlacementStrategyFIRSTFIT()
{
  ...
  8022f5:	6a 2c                	push   $0x2c
  8022f7:	e8 ad fa ff ff       	call   801da9 <syscall>
  8022fc:	83 c4 18             	add    $0x18,%esp
  8022ff:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_FIRSTFIT)
  802302:	83 7d fc 01          	cmpl   $0x1,-0x4(%ebp)
  802306:	75 07                	jne    80230f <sys_isUHeapPlacementStrategyFIRSTFIT+0x2a>
		return 1;
  802308:	b8 01 00 00 00       	mov    $0x1,%eax
  80230d:	eb 05                	jmp    802314 <sys_isUHeapPlacementStrategyFIRSTFIT+0x2f>
	else
		return 0;
...
00802316 <sys_isUHeapPlacementStrategyBESTFIT>:
uint32 sys_isUHeapPlacementStrategyBESTFIT()
{
  ...
  802326:	6a 2c                	push   $0x2c
  802328:	e8 7c fa ff ff       	call   801da9 <syscall>
  80232d:	83 c4 18             	add    $0x18,%esp
  802330:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_BESTFIT)
  802333:	83 7d fc 02          	cmpl   $0x2,-0x4(%ebp)
  802337:	75 07                	jne    802340 <sys_isUHeapPlacementStrategyBESTFIT+0x2a>
		return 1;
  802339:	b8 01 00 00 00       	mov    $0x1,%eax
  80233e:	eb 05                	jmp    802345 <sys_isUHeapPlacementStrategyBESTFIT+0x2f>
	else
		return 0;
...
00802347 <sys_isUHeapPlacementStrategyNEXTFIT>:
uint32 sys_isUHeapPlacementStrategyNEXTFIT()
{
  ...
  802359:	e8 4b fa ff ff       	call   801da9 <syscall>
  80235e:	83 c4 18             	add    $0x18,%esp
  802361:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_NEXTFIT)
  802364:	83 7d fc 03          	cmpl   $0x3,-0x4(%ebp)
  802368:	75 07                	jne    802371 <sys_isUHeapPlacementStrategyNEXTFIT+0x2a>
		return 1;
  80236a:	b8 01 00 00 00       	mov    $0x1,%eax
  80236f:	eb 05                	jmp    802376 <sys_isUHeapPlacementStrategyNEXTFIT+0x2f>
	else
		return 0;
...
00802378 <sys_isUHeapPlacementStrategyWORSTFIT>:
uint32 sys_isUHeapPlacementStrategyWORSTFIT()
{
  802378:	55                   	push   %ebp
  802379:	89 e5                	mov    %esp,%ebp
  80237b:	83 ec 10             	sub    $0x10,%esp
	uint32 ret = syscall(SYS_get_heap_strategy, 0, 0, 0, 0, 0);
  ...
  802388:	6a 2c                	push   $0x2c
  80238a:	e8 1a fa ff ff       	call   801da9 <syscall>
  80238f:	83 c4 18             	add    $0x18,%esp
  802392:	89 45 fc             	mov    %eax,-0x4(%ebp)
	if (ret == UHP_PLACE_WORSTFIT)
  802395:	83 7d fc 04          	cmpl   $0x4,-0x4(%ebp)
  802399:	75 07                	jne    8023a2 <sys_isUHeapPlacementStrategyWORSTFIT+0x2a>
		return 1;
  80239b:	b8 01 00 00 00       	mov    $0x1,%eax
  8023a0:	eb 05                	jmp    8023a7 <sys_isUHeapPlacementStrategyWORSTFIT+0x2f>
	else
		return 0;
...
008023a9 <sys_set_uheap_strategy>:
...
void sys_set_uheap_strategy(uint32 heapStrategy)
{
  ...
  8023b7:	6a 2d                	push   $0x2d
  8023b9:	e8 eb f9 ff ff       	call   801da9 <syscall>
...
int sys_check_LRU_lists(uint32* active_list_content, uint32* second_list_content, int actual_active_list_size, int actual_second_list_size)
{
  ...
  8023d8:	52                   	push   %edx
  8023d9:	50                   	push   %eax
  8023da:	6a 2e                	push   $0x2e
  8023dc:	e8 c8 f9 ff ff       	call   801da9 <syscall>
  8023e1:	83 c4 18             	add    $0x18,%esp
}
  8023e4:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  8023e7:	c9                   	leave  
  8023e8:	c3                   	ret    

008023e9 <sys_check_LRU_lists_free>:
...
int sys_check_LRU_lists_free(uint32* list_content, int list_size)
{
  ...
  8023f8:	52                   	push   %edx
  8023f9:	50                   	push   %eax
  8023fa:	6a 2f                	push   $0x2f
  8023fc:	e8 a8 f9 ff ff       	call   801da9 <syscall>
